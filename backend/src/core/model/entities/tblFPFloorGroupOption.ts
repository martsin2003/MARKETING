...
export class tblFPFloorGroupOption {
    ...
    @ManyToOne(type=>tblFPFloor, tblFPFloor=>tblFPFloor.tblFpFloorGroupOptions,{  nullable:false,onDelete: 'CASCADE', })
    @JoinColumn({ name:'intFPFloorGroupOptionFPFloorID'})
    intFpFloorGroupOptionFpFloor:tblFPFloor | null;


   
    @ManyToOne(type=>tblFPFloorGroup, tblFPFloorGroup=>tblFPFloorGroup.tblFpFloorGroupOptions,{  nullable:false, })
    @JoinColumn({ name:'intFPFloorGroupOptionFPFloorGroupID'})
    intFpFloorGroupOptionFpFloorGroup:tblFPFloorGroup | null;


   
    @ManyToOne(type=>tblFPFloorOption, tblFPFloorOption=>tblFPFloorOption.tblFpFloorGroupOptions,{  nullable:false, })
