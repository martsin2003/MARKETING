...
@Index("idx_20838_IX_tblWMDistributionRecipient",["intWMDistributionRecipientID","varWMDistributionRecipientEmailAddress","varWMDistributionRecipientName","varWMDistributionRecipientStatus",],{unique:true})
export class tblWMDistributionRecipient {
    ...
    @OneToMany(type=>tblWMReportDistribution, tblWMReportDistribution=>tblWMReportDistribution.intWmReportDistributionWmDistributionRecipient,{ onDelete: 'CASCADE' , })
