...
@Index('idx_17747_IX_tblFPElevationOptionDisplayOnLoad', [
  'bFPElevationOptionDisplayOnLoadDeletedFlg',
  'dteFPElevationOptionDisplayOnLoadModifiedDate',
  'intFpElevationOptionDisplayOnLoadFpElevation',
  'intFpElevationOptionDisplayOnLoadFpFloorOption',
  'intFPElevationOptionDisplayOnLoadModifiedBy'
])
export class tblFPElevationOptionDisplayOnLoad {
  ...
  @ManyToOne(
    type => tblFPElevation,
    tblFPElevation => tblFPElevation.tblFpElevationOptionDisplayOnLoads,
    { nullable: false }
  )
  ...
  @ManyToOne(
    ...
    tblFPFloorOption => tblFPFloorOption.tblFpElevationOptionDisplayOnLoads,
    { nullable: false }
  )
