...
@Index(
  'idx_18513_IX_tblMBFLotGallery',
  [
    'bMBFLotGalleryDefault',
    'dteMBFLotGalleryModifiedDate',
    'intMBFLotGalleryID',
    'intMbfLotGalleryLot',
    'intMBFLotGalleryNavOrder',
    'varMBFLotGalleryCaption',
    'varMBFLotGalleryCategory',
    'varMBFLotGalleryImageFile'
  ],
  { unique: true }
)
export class tblMBFLotGallery {
  ...
  @ManyToOne(type => tblMBFLot, tblMBFLot => tblMBFLot.tblMbfLotGallerys, {
    nullable: false,
    onDelete: 'CASCADE'
  })
