...
export class tblContactAutomatedEmailType {
    ...
    @OneToMany(type=>tblContactAutomatedEmail, tblContactAutomatedEmail=>tblContactAutomatedEmail.intContactAutomatedEmailContactAutomatedEmailType,{ onDelete: 'CASCADE' , })
