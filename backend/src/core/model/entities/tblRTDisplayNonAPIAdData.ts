...
@Index(
  'idx_19851_IX_tblRTDisplayNonAPIAdData',
  [
    'dteRTDisplayNonAPIAdDataDate',
    'intRTDisplayNonAPIAdDataBounces',
    'intRTDisplayNonAPIAdDataNewUsers',
    'intRTDisplayNonAPIAdDataPageviews',
    'intRtDisplayNonApiAdDataRtCampaign',
    'intRtDisplayNonApiAdDataRtMediaSource',
    'intRTDisplayNonAPIAdDataSessionDuration'
  ],
  { unique: true }
)
@Index('idx_19851_IX2_tblRTDisplayNonAPIAdData', [
  'dteRTDisplayNonAPIAdDataDate',
  'intRTDisplayNonAPIAdDataBounces',
  'intRTDisplayNonAPIAdDataNewUsers',
  'intRTDisplayNonAPIAdDataPageviews',
  ...
  'intRtDisplayNonApiAdDataRtMediaSource',
  'intRTDisplayNonAPIAdDataSessionDuration',
  'intRTDisplayNonAPIAdDataSessions'
])
export class tblRTDisplayNonAPIAdData {
  ...
  @ManyToOne(
    ...
    tblRTMediaSource => tblRTMediaSource.tblRtDisplayNonApiAdDatas,
  ...
  @ManyToOne(type => tblRTCampaign, tblRTCampaign => tblRTCampaign.tblRtDisplayNonApiAdDatas, {
    nullable: false,
    onDelete: 'CASCADE'
  })
