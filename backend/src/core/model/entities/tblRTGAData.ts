...
@Index(
  'idx_20091_IX_tblRTGAData',
  [
    'dteRTGADataDate',
    'intRTGADataID',
    'intRtgaDataMetric',
    'intRtgaDataRtCampaign',
    'intRTGADataValue'
  ],
  { unique: true }
)
...
export class tblRTGAData {
  ...
  @ManyToOne(type => tblRTCampaign, tblRTCampaign => tblRTCampaign.tblRtgaDatas, {
    nullable: false,
    onDelete: 'CASCADE'
  })
  ...
  @ManyToOne(type => tblRTGAMetric, tblRTGAMetric => tblRTGAMetric.tblRtgaDatas, {
    nullable: false,
    onDelete: 'CASCADE'
  })
