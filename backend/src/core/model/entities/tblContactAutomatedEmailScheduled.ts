...
export class tblContactAutomatedEmailScheduled {
  ...
  @ManyToOne(type => tblContact, tblContact => tblContact.tblContactAutomatedEmailScheduleds, {
    nullable: false,
    onDelete: 'CASCADE'
  })
  ...
  @ManyToOne(
    ...
    tblContactAutomatedEmail => tblContactAutomatedEmail.tblContactAutomatedEmailScheduleds,
