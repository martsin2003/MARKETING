...
@Index("idx_18675_IX_tblMBFPhaseUpdate",["dteMBFPhaseUpdateModifiedDate","intMBFPhaseUpdateID","intMBFPhaseUpdateNavOrder","intMBFPhaseUpdatePhaseID","varMBFPhaseUpdateName","varMBFPhaseUpdateStatus",],{unique:true})
