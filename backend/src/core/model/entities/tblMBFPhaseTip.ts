...
@Index("idx_18655_IX_tblMBFPhaseTip",["dteMBFPhaseTipModifiedDate","intMBFPhaseTipID","intMBFPhaseTipPhaseID","varMBFPhaseTipName","varMBFPhaseTipStatus",],{unique:true})
