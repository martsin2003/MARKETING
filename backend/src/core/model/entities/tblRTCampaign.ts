...
@Index('idx_19572_IX_RTCampaignAPIID_FOR_EMI', [
  'bRTCampaignDelete',
  'intRTCampaignAPIID',
  'intRTCampaignAdvertisingTypeID',
  'intRTCampaignCampaignTypeID',
  'varRTCampaignCampaignMedium',
  'varRTCampaignCampaignSource'
])
@Index('idx_19572_IX_RTCampaignAPIID', [
  'intRTCampaignAPIID',
  'intRTCampaignAudienceTypeID',
  'intRTCampaignID',
  'varRTCampaignCampaignSource'
])
@Index('idx_19572_IX_tblRTCampaign_RTCampaignRTCredentialProviderID', [
  'intRTCampaignAPIID',
  'intRTCampaignCampaignTypeID',
  'intRTCampaignRTCredentialProviderID'
])
@Index('idx_19572_IX_RTCampaignCampaignTypeID', ['intRTCampaignCampaignTypeID'])
@Index('idx_19572_IX2_RTCampaign', [
  'intRTCampaignCampaignTypeID',
  'intRTCampaignID',
  'varRTCampaignDisplayType'
])
@Index('idx_19572_IX_tblRTCampaign_RTCampaignCampaignTypeID', [
  'intRTCampaignCampaignTypeID',
  'intRTCampaignID'
])
export class tblRTCampaign {
  ...
  @OneToMany(type => tblRTCPCMetric, tblRTCPCMetric => tblRTCPCMetric.intRtcpcMetricCampaign, {
    onDelete: 'CASCADE'
  })
  tblRtcpcMetrics: tblRTCPCMetric[];

  @OneToMany(
    type => tblRTCampaignResponse,
    tblRTCampaignResponse => tblRTCampaignResponse.intRtCampaignResponseCampaign,
    { onDelete: 'CASCADE' }
  )
  tblRtCampaignResponses: tblRTCampaignResponse[];

  @OneToMany(
    type => tblRTCampaignUTM,
    tblRTCampaignUTM => tblRTCampaignUTM.intRtCampaignUtmrtCampaign,
    { onDelete: 'CASCADE' }
  )
  tblRtCampaignUtms: tblRTCampaignUTM[];

  @OneToMany(
    type => tblRTConfigSiteCampaign,
    tblRTConfigSiteCampaign => tblRTConfigSiteCampaign.intRtConfigSiteCampaignRtCampaign,
    { onDelete: 'CASCADE' }
  )
  ...
  @OneToMany(
    ...
    tblRTDisplayAdGroup => tblRTDisplayAdGroup.intRtDisplayAdGroupRtCampaign,
    { onDelete: 'CASCADE' }
  )
  tblRtDisplayAdGroups: tblRTDisplayAdGroup[];

  @OneToMany(
    type => tblRTDisplayNonAPIAdData,
    tblRTDisplayNonAPIAdData => tblRTDisplayNonAPIAdData.intRtDisplayNonApiAdDataRtCampaign,
    { onDelete: 'CASCADE' }
  )
  ...
  @OneToMany(
    ...
    tblRTEmailMarketingItem => tblRTEmailMarketingItem.intRtEmailMarketingItemCampaign,
    { onDelete: 'CASCADE' }
  )
  tblRtEmailMarketingItems: tblRTEmailMarketingItem[];

  @OneToMany(type => tblRTFBAIAdSet, tblRTFBAIAdSet => tblRTFBAIAdSet.intRtfbaiAdSetRtCampaign, {
    onDelete: 'CASCADE'
  })
  tblRtfbaiAdSets: tblRTFBAIAdSet[];

  @OneToMany(type => tblRTFBIData, tblRTFBIData => tblRTFBIData.intRtfbiDataRtCampaign, {
    onDelete: 'CASCADE'
  })
  ...
  @OneToMany(
    ...
    tblRTFBILabeledData => tblRTFBILabeledData.intRtfbiLabeledDataRtCampaign,
    { onDelete: 'CASCADE' }
  )
  tblRtfbiLabeledDatas: tblRTFBILabeledData[];

  @OneToMany(
    type => tblRTFBIMonthlyAnalysis,
    tblRTFBIMonthlyAnalysis => tblRTFBIMonthlyAnalysis.intRtfbiMonthlyAnalysisRtCampaign,
    { onDelete: 'CASCADE' }
  )
  tblRtfbiMonthlyAnalysiss: tblRTFBIMonthlyAnalysis[];

  @OneToMany(type => tblRTFBIPost, tblRTFBIPost => tblRTFBIPost.intRtfbiPostRtCampaign, {
    onDelete: 'CASCADE'
  })
  tblRtfbiPosts: tblRTFBIPost[];

  @OneToMany(type => tblRTGAData, tblRTGAData => tblRTGAData.intRtgaDataRtCampaign, {
    onDelete: 'CASCADE'
  })
  tblRtgaDatas: tblRTGAData[];

  @OneToMany(type => tblRTGAGoal, tblRTGAGoal => tblRTGAGoal.intRtgaGoalRtCampaign, {
    onDelete: 'CASCADE'
  })
  ...
  @OneToMany(
    ...
    tblRTGALabeledData => tblRTGALabeledData.intRtgaLabeledDataRtCampaign,
    { onDelete: 'CASCADE' }
  )
  tblRtgaLabeledDatas: tblRTGALabeledData[];

  @OneToMany(
    type => tblRTGAMonthlyAnalysis,
    tblRTGAMonthlyAnalysis => tblRTGAMonthlyAnalysis.intRtgaMonthlyAnalysisRtCampaign,
    { onDelete: 'CASCADE' }
  )
  ...
  @OneToMany(
    ...
    tblRTPaidSearchAdGroup => tblRTPaidSearchAdGroup.intRtPaidSearchAdGroupRtCampaign,
    { onDelete: 'CASCADE' }
  )
  ...
  @OneToMany(
    ...
    tblRTPaidSearchCampaignData =>
      tblRTPaidSearchCampaignData.intRtPaidSearchCampaignDataRtCampaign,
    { onDelete: 'CASCADE' }
  )
  ...
  @OneToMany(
    ...
    tblRTPaidSearchGoalCampaignData =>
      tblRTPaidSearchGoalCampaignData.intRtPaidSearchGoalCampaignDataRtCampaign,
    { onDelete: 'CASCADE' }
  )
