...
@Index("idx_19865_IX2_tblRTDsiplayNonAPIGoalData",["dteRTDisplayNonAPIGoalDataDate","intRTDisplayNonAPIGoalDataRTCampaignID","intRtDisplayNonApiGoalDataRtgaGoal","intRtDisplayNonApiGoalDataRtMediaSource","intRTDisplayNonAPIGoalDataValue",])
@Index("idx_19865_IX_tblRTDisplayNonAPIGoalData",["dteRTDisplayNonAPIGoalDataDate","intRTDisplayNonAPIGoalDataRTCampaignID","intRtDisplayNonApiGoalDataRtgaGoal","intRtDisplayNonApiGoalDataRtMediaSource","intRTDisplayNonAPIGoalDataValue",],{unique:true})
export class tblRTDisplayNonAPIGoalData {
    ...
    @ManyToOne(type=>tblRTGAGoal, tblRTGAGoal=>tblRTGAGoal.tblRtDisplayNonApiGoalDatas,{  nullable:false,onDelete: 'CASCADE', })
    @JoinColumn({ name:'intRTDisplayNonAPIGoalDataRTGAGoalID'})
    intRtDisplayNonApiGoalDataRtgaGoal:tblRTGAGoal | null;


   
    @ManyToOne(type=>tblRTMediaSource, tblRTMediaSource=>tblRTMediaSource.tblRtDisplayNonApiGoalDatas,{  nullable:false,onDelete: 'CASCADE', })
