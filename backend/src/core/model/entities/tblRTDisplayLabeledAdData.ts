...
@Index("idx_19829_IX_tblRTDisplayLabeledAdData",["dteRTDisplayLabeledAdDataCreatedDate","dteRTDisplayLabeledAdDataEndTime","intRTDisplayLabeledAdDataID","intRtDisplayLabeledAdDataRtDisplayAd","intRtDisplayLabeledAdDataRtDisplayMetric","varRTDisplayLabeledAdDataLabel",])
@Index("idx_19829_IX2_tblRTDisplayLabeledAdData",["dteRTDisplayLabeledAdDataEndTime","intRtDisplayLabeledAdDataRtDisplayAd","intRtDisplayLabeledAdDataRtDisplayMetric","intRTDisplayLabeledAdDataValue","varRTDisplayLabeledAdDataLabel",])
export class tblRTDisplayLabeledAdData {
    ...
    @ManyToOne(type=>tblRTDisplayAd, tblRTDisplayAd=>tblRTDisplayAd.tblRtDisplayLabeledAdDatas,{  nullable:false,onDelete: 'CASCADE', })
    @JoinColumn({ name:'intRTDisplayLabeledAdDataRTDisplayAdID'})
    intRtDisplayLabeledAdDataRtDisplayAd:tblRTDisplayAd | null;


   
    @ManyToOne(type=>tblRTDisplayMetric, tblRTDisplayMetric=>tblRTDisplayMetric.tblRtDisplayLabeledAdDatas,{  nullable:false,onDelete: 'CASCADE', })
