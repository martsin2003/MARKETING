...
export class tblContactAutomatedEmail {
  ...
  @ManyToOne(
    type => tblContactAutomatedEmailType,
    tblContactAutomatedEmailType => tblContactAutomatedEmailType.tblContactAutomatedEmails,
  ...
  @ManyToOne(
    ...
    tblCommunityARHeaderGraphicCategory =>
      tblCommunityARHeaderGraphicCategory.tblContactAutomatedEmails,
    { nullable: false, onDelete: 'CASCADE' }
  )
  ...
  @OneToMany(
    ...
    tblContactAutomatedEmailCancelled =>
      tblContactAutomatedEmailCancelled.intContactAutomatedEmailCancelledContactAutomatedEmail,
    { onDelete: 'CASCADE' }
  )
  ...
  @OneToMany(
    ...
    tblContactAutomatedEmailPaused =>
      tblContactAutomatedEmailPaused.intContactAutomatedEmailPausedContactAutomatedEmail,
    { onDelete: 'CASCADE' }
  )
  ...
  @OneToMany(
    ...
    tblContactAutomatedEmailScheduled =>
      tblContactAutomatedEmailScheduled.intContactAutomatedEmailScheduledContactAutomatedEmail,
    { onDelete: 'CASCADE' }
  )
  ...
  @OneToMany(
    ...
    tblContactAutomatedEmailSent =>
      tblContactAutomatedEmailSent.intContactAutomatedEmailSentContactAutomatedEmail,
    { onDelete: 'CASCADE' }
  )
