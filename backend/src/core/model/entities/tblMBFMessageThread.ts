...
@Index(
  'idx_18593_IX_tblMBFMessageThread',
  [
    'bMBFMessageThreadClientFlg',
    'dteMBFMessageThreadCreatedDate',
    'intMBFMessageThreadEmailMessageID',
    'intMbfMessageThreadMbfMessage',
    'intMBFMessageThreadMBFTeamMemberID',
    'varMBFMessageThreadNonce',
    'varMBFMessageThreadSubmitterName'
  ],
  { unique: true }
)
export class tblMBFMessageThread {
  ...
  @ManyToOne(type => tblMBFMessage, tblMBFMessage => tblMBFMessage.tblMbfMessageThreads, {
    nullable: false,
    onDelete: 'CASCADE'
  })
  ...
  @OneToMany(
    type => tblMBFMessageThreadAttachment,
    tblMBFMessageThreadAttachment =>
      tblMBFMessageThreadAttachment.intMbfMessageThreadAttachmentMbfMessageThread,
    { onDelete: 'CASCADE' }
  )
