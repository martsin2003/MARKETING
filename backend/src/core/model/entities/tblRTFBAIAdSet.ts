...
@Index("idx_19992_IX_tblRTFBAIAdSet",["dteRTFBAIAdSetEndDate","dteRTFBAIAdSetStartDate","intRTFBAIAdSetFBAdSetID","intRtfbaiAdSetRtCampaign",],{unique:true})
export class tblRTFBAIAdSet {
    ...
    @ManyToOne(type=>tblRTCampaign, tblRTCampaign=>tblRTCampaign.tblRtfbaiAdSets,{  nullable:false,onDelete: 'CASCADE', })
    ...
    @OneToMany(type=>tblRTFBAIAd, tblRTFBAIAd=>tblRTFBAIAd.intRtfbaiAdRtfbaiAdSet,{ onDelete: 'CASCADE' , })
