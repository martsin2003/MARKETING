...
@Index(
  'idx_17198_IX_tblContactAutomatedEmailPaused',
  [
    'dteContactAutomatedEmailPausedPausedDate',
    'intContactAutomatedEmailPausedContactAutomatedEmail',
    'intContactAutomatedEmailPausedContact',
    'intContactAutomatedEmailPausedID'
  ],
  { unique: true }
)
export class tblContactAutomatedEmailPaused {
  ...
  @ManyToOne(type => tblContact, tblContact => tblContact.tblContactAutomatedEmailPauseds, {
    nullable: false,
    onDelete: 'CASCADE'
  })
  ...
  @ManyToOne(
    ...
    tblContactAutomatedEmail => tblContactAutomatedEmail.tblContactAutomatedEmailPauseds,
