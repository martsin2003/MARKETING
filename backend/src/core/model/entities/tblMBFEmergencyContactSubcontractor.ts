...
@Index("idx_18436_IX_tblMBFEmergencyContactSubcontractor",["varMBFEmergencyContactSubcontractorName","varMBFEmergencyContactSubcontractorStatus",],{unique:true})
export class tblMBFEmergencyContactSubcontractor {
    ...
    @OneToMany(type=>tblMBFEmergencyContactSubcontractorType, tblMBFEmergencyContactSubcontractorType=>tblMBFEmergencyContactSubcontractorType.intMbfEmergencyContactSubcontractorTypeSubcontractor,{ onDelete: 'CASCADE' , })
