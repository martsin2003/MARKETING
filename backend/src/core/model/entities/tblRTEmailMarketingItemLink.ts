...
@Index("idx_19936_IX_RTEmailMarketingItemLinkAPIID",["intRTEmailMarketingItemLinkItemAPIID","intRtEmailMarketingItemLinkItem","intRTEmailMarketingItemLinkOrder","varRTEmailMarketingItemLinkHash","varRTEmailMarketingItemLinkName","varRTEmailMarketingItemLinkURL",],{unique:true})
export class tblRTEmailMarketingItemLink {
    ...
    @ManyToOne(type=>tblRTEmailMarketingItem, tblRTEmailMarketingItem=>tblRTEmailMarketingItem.tblRtEmailMarketingItemLinks,{  nullable:false,onDelete: 'CASCADE', })
