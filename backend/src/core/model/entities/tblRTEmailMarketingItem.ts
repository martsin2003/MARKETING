...
@Index("idx_19917_IX_RTEmailMarketingItemCampaignID",["intRtEmailMarketingItemCampaign","varRTEmailMarketingItemContent","varRTEmailMarketingItemSubject",],{unique:true})
@Index("idx_19917_IX_RTEmailMarketingItemConfigSiteID",["intRtEmailMarketingItemCampaign","intRtEmailMarketingItemRtConfigSite","varRTEmailMarketingItemContent","varRTEmailMarketingItemSubject",],{unique:true})
export class tblRTEmailMarketingItem {
    ...
    @ManyToOne(type=>tblRTCampaign, tblRTCampaign=>tblRTCampaign.tblRtEmailMarketingItems,{  nullable:false,onDelete: 'CASCADE', })
    ...
    @ManyToOne(type=>tblRTConfigSite, tblRTConfigSite=>tblRTConfigSite.tblRtEmailMarketingItems,{  nullable:false,onDelete: 'CASCADE', })
    ...
    @ManyToOne(type=>tblRTMediaSource, tblRTMediaSource=>tblRTMediaSource.tblRtEmailMarketingItems,{  nullable:false,onDelete: 'CASCADE', })
    ...
    @OneToMany(type=>tblRTEmailMarketingItemGAGoalData, tblRTEmailMarketingItemGAGoalData=>tblRTEmailMarketingItemGAGoalData.intRtEmailMarketingItemGaGoalDataRtEmailMarketingItem,{ onDelete: 'CASCADE' , })
    tblRtEmailMarketingItemGaGoalDatas:tblRTEmailMarketingItemGAGoalData[];
    

   
    @OneToMany(type=>tblRTEmailMarketingItemLink, tblRTEmailMarketingItemLink=>tblRTEmailMarketingItemLink.intRtEmailMarketingItemLinkItem,{ onDelete: 'CASCADE' , })
    tblRtEmailMarketingItemLinks:tblRTEmailMarketingItemLink[];
    

   
    @OneToMany(type=>tblRTEmailMarketingItemRead, tblRTEmailMarketingItemRead=>tblRTEmailMarketingItemRead.intRtEmailMarketingItemReadItem,{ onDelete: 'CASCADE' , })
    tblRtEmailMarketingItemReads:tblRTEmailMarketingItemRead[];
    

   
    @OneToMany(type=>tblRTEmailUserSummary, tblRTEmailUserSummary=>tblRTEmailUserSummary.intRtEmailUserSummaryEmailMarketingItem,{ onDelete: 'CASCADE' , })
