...
@Index('idx_20340_IX2_tblRTPaidSearchGoalAdData', [
  'dteRTPaidSearchGoalAdDataDate',
  'intRtPaidSearchGoalAdDataRtPaidSearchAd',
  'intRtPaidSearchGoalAdDataRtPaidSearchGoal',
  'intRTPaidSearchGoalAdDataValue'
])
@Index('idx_20340_IX_tblRTPaidSearchGoalAdData', [
  'dteRTPaidSearchGoalAdDataDate',
  'intRTPaidSearchGoalAdDataID',
  'intRtPaidSearchGoalAdDataRtPaidSearchAd',
  'intRtPaidSearchGoalAdDataRtPaidSearchGoal'
])
export class tblRTPaidSearchGoalAdData {
  ...
  @ManyToOne(
    ...
    tblRTPaidSearchAd => tblRTPaidSearchAd.tblRtPaidSearchGoalAdDatas,
  ...
  @ManyToOne(
    ...
    tblRTPaidSearchGoal => tblRTPaidSearchGoal.tblRtPaidSearchGoalAdDatas,
    { nullable: false, onDelete: 'CASCADE' }
  )
