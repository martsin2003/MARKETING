...
@Index("idx_20136_IX2_tblRTGALabeledDataDimension",["intRtgaLabeledDataDimensionRtgaLabeledData","varRTGALabeledDataDimension","varRTGALabeledDataDimensionValue",])
@Index("idx_20136_IX_tblRTGALabeledDataDimension",["intRtgaLabeledDataDimensionRtgaLabeledData","varRTGALabeledDataDimension","varRTGALabeledDataDimensionValue",],{unique:true})
export class tblRTGALabeledDataDimension {
    ...
    @ManyToOne(type=>tblRTGALabeledData, tblRTGALabeledData=>tblRTGALabeledData.tblRtgaLabeledDataDimensions,{  nullable:false,onDelete: 'CASCADE', })
