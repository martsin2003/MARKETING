...
@Index(
  'idx_19982_IX_tblRTFBAIAd',
  ['dteRTFBAIAdEndDate', 'dteRTFBAIAdStartDate', 'intRTFBAIAdFBAdID', 'intRtfbaiAdRtfbaiAdSet'],
  { unique: true }
)
export class tblRTFBAIAd {
  ...
  @ManyToOne(type => tblRTFBAIAdSet, tblRTFBAIAdSet => tblRTFBAIAdSet.tblRtfbaiAds, {
    nullable: false,
    onDelete: 'CASCADE'
  })
  ...
  @OneToMany(type => tblRTFBAIData, tblRTFBAIData => tblRTFBAIData.intRtfbaiDataRtfbaiAd, {
    onDelete: 'CASCADE'
  })
  ...
  @OneToMany(
    ...
    tblRTFBAILabeledData => tblRTFBAILabeledData.intRtfbaiLabeledDataRtfbaiAd,
    { onDelete: 'CASCADE' }
  )
