...
@Index('idx_19517_IX_tblRTAdvertisingMedium', [
  'bRTArchive',
  'dteRTAdvertisingMediumCreatedDate',
  'dteRTAdvertisingMediumModifiedDate',
  'varRTAdvertisingMediumName',
  'varRTAdvertisingMediumStatus'
])
export class tblRTAdvertisingMedium {
  ...
  @OneToMany(
    ...
    tblRTCampaignUTM => tblRTCampaignUTM.intRtCampaignUtmrtAdvertisingMedium,
    { onDelete: 'CASCADE' }
  )
