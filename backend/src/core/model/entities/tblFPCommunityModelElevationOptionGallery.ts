...
export class tblFPCommunityModelElevationOptionGallery {
    ...
    @ManyToOne(type=>tblFPFloorOption, tblFPFloorOption=>tblFPFloorOption.tblFpCommunityModelElevationOptionGallerys,{  nullable:false, })
    ...
    @ManyToOne(type=>tblFPCommunityModelElevation, tblFPCommunityModelElevation=>tblFPCommunityModelElevation.tblFpCommunityModelElevationOptionGallerys,{  nullable:false,onDelete: 'CASCADE', })
