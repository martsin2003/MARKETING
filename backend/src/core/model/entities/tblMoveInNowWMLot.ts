...
export class tblMoveInNowWMLot {
    ...
    @ManyToOne(type=>tblMoveInNow, tblMoveInNow=>tblMoveInNow.tblMoveInNowWmLots,{ primary:true, nullable:false,onDelete: 'CASCADE', })
    @JoinColumn({ name:'intMoveInNowWMLotMoveInNowID'})
    intMoveInNowWmLotMoveInNow:tblMoveInNow | null;


   
    @ManyToOne(type=>tblWMLot, tblWMLot=>tblWMLot.tblMoveInNowWmLots,{ primary:true, nullable:false,onDelete: 'CASCADE', })
