...
export class tblHomeEstimateFinancePlan {
    ...
    @ManyToOne(type=>tblHomeEstimate, tblHomeEstimate=>tblHomeEstimate.tblHomeEstimateFinancePlans,{ onDelete: 'CASCADE', })
    @JoinColumn({ name:'intHomeEstimateID'})
    intHomeEstimate:tblHomeEstimate | null;


   
    @ManyToOne(type=>tblFinancePlan, tblFinancePlan=>tblFinancePlan.tblHomeEstimateFinancePlans,{ onDelete: 'SET NULL', })
