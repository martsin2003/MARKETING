...
export class tblFPFloorOption {
    ...
    @ManyToOne(type=>tblFPFloor, tblFPFloor=>tblFPFloor.tblFpFloorOptions,{  nullable:false,onDelete: 'CASCADE', })
    ...
    @OneToMany(type=>tblFPCommunityModelElevationOptionDesc, tblFPCommunityModelElevationOptionDesc=>tblFPCommunityModelElevationOptionDesc.intFpCommunityModelElevationOptionDescFpFloorOption)
    tblFpCommunityModelElevationOptionDescs:tblFPCommunityModelElevationOptionDesc[];
    

   
    @OneToMany(type=>tblFPCommunityModelElevationOptionDisplayAsStandard, tblFPCommunityModelElevationOptionDisplayAsStandard=>tblFPCommunityModelElevationOptionDisplayAsStandard.intFpCommunityModelElevationOptionDisplayAsStandardFpFloorOptio)
    tblFpCommunityModelElevationOptionDisplayAsStandards:tblFPCommunityModelElevationOptionDisplayAsStandard[];
    

   
    @OneToMany(type=>tblFPCommunityModelElevationOptionGallery, tblFPCommunityModelElevationOptionGallery=>tblFPCommunityModelElevationOptionGallery.intFpCommunityModelElevationOptionGalleryFpFloorOption)
    tblFpCommunityModelElevationOptionGallerys:tblFPCommunityModelElevationOptionGallery[];
    

   
    @OneToMany(type=>tblFPCommunityModelElevationOptionRemove, tblFPCommunityModelElevationOptionRemove=>tblFPCommunityModelElevationOptionRemove.intFpCommunityModelElevationOptionRemoveFpFloorOption)
    tblFpCommunityModelElevationOptionRemoves:tblFPCommunityModelElevationOptionRemove[];
    

   
    @OneToMany(type=>tblFPCommunityModelOptionGallery, tblFPCommunityModelOptionGallery=>tblFPCommunityModelOptionGallery.intFpCommunityModelOptionGalleryFpFloorOption)
    tblFpCommunityModelOptionGallerys:tblFPCommunityModelOptionGallery[];
    

   
    @OneToMany(type=>tblFPElevationOptionAltPNG, tblFPElevationOptionAltPNG=>tblFPElevationOptionAltPNG.intFpElevationOptionAltPngfpFloorOption)
    tblFpElevationOptionAltPngs:tblFPElevationOptionAltPNG[];
    

   
    @OneToMany(type=>tblFPElevationOptionDisplayOnLoad, tblFPElevationOptionDisplayOnLoad=>tblFPElevationOptionDisplayOnLoad.intFpElevationOptionDisplayOnLoadFpFloorOption)
    tblFpElevationOptionDisplayOnLoads:tblFPElevationOptionDisplayOnLoad[];
    

   
    @OneToMany(type=>tblFPElevationOptionRemove, tblFPElevationOptionRemove=>tblFPElevationOptionRemove.intFpElevationOptionRemoveFpFloorOption)
    tblFpElevationOptionRemoves:tblFPElevationOptionRemove[];
    

   
    @OneToMany(type=>tblFPFloorGroupOption, tblFPFloorGroupOption=>tblFPFloorGroupOption.intFpFloorGroupOptionFpFloorOption)
    ...
    @OneToMany(type=>tblFPFloorOption, tblFPFloorOption=>tblFPFloorOption.intFpFloorOptionFpFloorOption)
    tblFpFloorOptions:tblFPFloorOption[];
    

   
    @OneToMany(type=>tblFPFloorOptionAutoTurnOn, tblFPFloorOptionAutoTurnOn=>tblFPFloorOptionAutoTurnOn.intFpFloorOptionAutoTurnOnFpFloorOption,{ onDelete: 'CASCADE' , })
    tblFpFloorOptionAutoTurnOns:tblFPFloorOptionAutoTurnOn[];
    

   
    @OneToMany(type=>tblFPFloorOptionAutoTurnOn, tblFPFloorOptionAutoTurnOn=>tblFPFloorOptionAutoTurnOn.intFpFloorOptionAutoTurnOnTargetFpFloorOption)
    tblFpFloorOptionAutoTurnOns2:tblFPFloorOptionAutoTurnOn[];
    

   
    @OneToMany(type=>tblFPFloorOptionConditional, tblFPFloorOptionConditional=>tblFPFloorOptionConditional.intFpFloorOptionConditionalFpFloorOption,{ onDelete: 'CASCADE' , })
    tblFpFloorOptionConditionals:tblFPFloorOptionConditional[];
    

   
    @OneToMany(type=>tblFPFloorOptionConditionalCondition, tblFPFloorOptionConditionalCondition=>tblFPFloorOptionConditionalCondition.intFpFloorOptionConditionalConditionTargetFpFloorOption)
    tblFpFloorOptionConditionalConditions:tblFPFloorOptionConditionalCondition[];
    

   
    @OneToMany(type=>tblFPFloorOptionExclude, tblFPFloorOptionExclude=>tblFPFloorOptionExclude.intFpFloorOptionExcludeFpFloorOption,{ onDelete: 'CASCADE' , })
    tblFpFloorOptionExcludes:tblFPFloorOptionExclude[];
    

   
    @OneToMany(type=>tblFPFloorOptionExclude, tblFPFloorOptionExclude=>tblFPFloorOptionExclude.intFpFloorOptionExcludeTargetFpFloorOption)
    tblFpFloorOptionExcludes2:tblFPFloorOptionExclude[];
    

   
    @OneToMany(type=>tblFPFloorOptionGallery, tblFPFloorOptionGallery=>tblFPFloorOptionGallery.intFpFloorOptionGalleryFpFloorOption)
    tblFpFloorOptionGallerys:tblFPFloorOptionGallery[];
    

   
    @OneToMany(type=>tblFPFloorOptionRequire, tblFPFloorOptionRequire=>tblFPFloorOptionRequire.intFpFloorOptionRequireFpFloorOption,{ onDelete: 'CASCADE' , })
    tblFpFloorOptionRequires:tblFPFloorOptionRequire[];
    

   
    @OneToMany(type=>tblFPFloorOptionRequire, tblFPFloorOptionRequire=>tblFPFloorOptionRequire.intFpFloorOptionRequireTargetFpFloorOption)
    tblFpFloorOptionRequires2:tblFPFloorOptionRequire[];
    

   
    @OneToMany(type=>tblFPFloorOptionRequireOne, tblFPFloorOptionRequireOne=>tblFPFloorOptionRequireOne.intFpFloorOptionRequireOneTargetFpFloorOption)
    tblFpFloorOptionRequireOnes:tblFPFloorOptionRequireOne[];
    

   
    @OneToMany(type=>tblFPModelGenericElevationOptionGallery, tblFPModelGenericElevationOptionGallery=>tblFPModelGenericElevationOptionGallery.intFpModelGenericElevationOptionGalleryFpFloorOption)
