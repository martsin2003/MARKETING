...
export class tblHomeEstimateOption {
  ...
  @ManyToOne(type => tblHomeEstimate, tblHomeEstimate => tblHomeEstimate.tblHomeEstimateOptions, {
    nullable: false,
    onDelete: 'CASCADE'
  })
  ...
  @ManyToOne(
    type => tblHEOptionGroup,
    tblHEOptionGroup => tblHEOptionGroup.tblHomeEstimateOptions,
    {}
  )
