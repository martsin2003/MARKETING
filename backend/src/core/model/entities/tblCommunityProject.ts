...
@Index("idx_16933_IX_tblCommunityProject",["dteCommunityProjectCreatedDate","dteCommunityProjectModifiedDate","intCommunityProjectCommunity","varCommunityProjectCode","varCommunityProjectName",],{unique:true})
export class tblCommunityProject {
    ...
    @ManyToOne(type=>tblCommunity, tblCommunity=>tblCommunity.tblCommunityProjects,{  nullable:false,onDelete: 'CASCADE', })
    ...
    @OneToMany(type=>tblCommunitySiteplan, tblCommunitySiteplan=>tblCommunitySiteplan.intCommunitySiteplanCommunityProject,{ onDelete: 'CASCADE' , })
    tblCommunitySiteplans:tblCommunitySiteplan[];
    

   
    @OneToMany(type=>tblContractHomesite, tblContractHomesite=>tblContractHomesite.intContractHomesiteCommunityProject,{ onDelete: 'CASCADE' , })
    tblContractHomesites:tblContractHomesite[];
    

   
    @OneToMany(type=>tblContractPlanProject, tblContractPlanProject=>tblContractPlanProject.intContractPlanProjectCommunityProject,{ onDelete: 'CASCADE' , })
    tblContractPlanProjects:tblContractPlanProject[];
    

   
    @OneToMany(type=>tblMBFCommunityProjectMessageEscalation, tblMBFCommunityProjectMessageEscalation=>tblMBFCommunityProjectMessageEscalation.intMbfCommunityProjectMessageEscalationCommunityProject,{ onDelete: 'CASCADE' , })
    tblMbfCommunityProjectMessageEscalations:tblMBFCommunityProjectMessageEscalation[];
    

   
    @OneToMany(type=>tblModelCode, tblModelCode=>tblModelCode.intModelCodeCommunityProject,{ onDelete: 'CASCADE' , })
    tblModelCodes:tblModelCode[];
    

   
    @OneToMany(type=>tblModelPlanProject, tblModelPlanProject=>tblModelPlanProject.intModelPlanProjectCommunityProject)
