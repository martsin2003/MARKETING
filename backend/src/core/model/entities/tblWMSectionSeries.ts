...
@Index("idx_20948_IX_tblWMSectionSeries",["intWMSectionSeriesID","intWMSectionSeriesWMCommunitySeriesID","intWMSectionSeriesWMSectionID","varWMSectionSeriesColor","varWMSectionSeriesStatus",],{unique:true})
export class tblWMSectionSeries {
    ...
    @OneToMany(type=>tblWMSectionSeriesMarking, tblWMSectionSeriesMarking=>tblWMSectionSeriesMarking.intWmSectionSeriesMarkingWmSectionSeries,{ onDelete: 'CASCADE' , })
