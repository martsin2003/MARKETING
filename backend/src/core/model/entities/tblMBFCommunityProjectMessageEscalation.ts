...
@Index(
  'idx_18385_IX_tblMBFCommunityProjectMessageEscalation',
  [
    'intMbfCommunityProjectMessageEscalationCommunityProject',
    'intMBFCommunityProjectMessageEscalationMBFTeamMemberID',
    'varMBFCommunityProjectMessageEscalationLevel'
  ],
  { unique: true }
)
export class tblMBFCommunityProjectMessageEscalation {
  ...
  @ManyToOne(
    ...
    tblCommunityProject => tblCommunityProject.tblMbfCommunityProjectMessageEscalations,
