...
@Index(
  'idx_16905_IX_tblCommunityOfferAddendum',
  [
    'dteCommunityOfferAddendumOfferCreatedDate',
    'intCommunityOfferAddendumCommunity',
    'intCommunityOfferAddendumOfferAddendumID'
  ],
  { unique: true }
)
export class tblCommunityOfferAddendum {
  ...
  @ManyToOne(type => tblCommunity, tblCommunity => tblCommunity.tblCommunityOfferAddendums, {
    nullable: false
  })
