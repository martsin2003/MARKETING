...
@Index('idx_20376_IX_tblRTPaidSearchKeywordData', [
  'dteRTPaidSearchKeywordDataCreatedDate',
  'dteRTPaidSearchKeywordDataEndTime',
  'intRTPaidSearchKeywordDataID',
  'intRtPaidSearchKeywordDataRtPaidSearchKeyword',
  'intRtPaidSearchKeywordDataRtPaidSearchMetric'
])
@Index('idx_20376_IX2_tblRTPaidSearchKeywordData', [
  'dteRTPaidSearchKeywordDataEndTime',
  'intRTPaidSearchKeywordDataID',
  'intRtPaidSearchKeywordDataRtPaidSearchKeyword',
  'intRtPaidSearchKeywordDataRtPaidSearchMetric',
  'intRTPaidSearchKeywordDataValue'
])
export class tblRTPaidSearchKeywordData {
  ...
  @ManyToOne(
    ...
    tblRTPaidSearchKeyword => tblRTPaidSearchKeyword.tblRtPaidSearchKeywordDatas,
  ...
  @ManyToOne(
    ...
    tblRTPaidSearchMetric => tblRTPaidSearchMetric.tblRtPaidSearchKeywordDatas,
    { nullable: false, onDelete: 'CASCADE' }
  )
