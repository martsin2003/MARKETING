...
@Index("idx_17331_IX_tblContractPlanProjectHEOption",["curContractPlanProjectHEOptionHEOptionUnitPrice","dteContractPlanProjectHEOptionCreatedDate","dteContractPlanProjectHEOptionModifiedDate","intContractPlanProjectHeOptionContractPlanProject","intContractPlanProjectHEOptionHEOptionID","varContractPlanProjectHEOptionStatus",],{unique:true})
@Index("idx_17331_IX_tblContractPlanProjectHEOption2",["intContractPlanProjectHeOptionContractPlanProject","intContractPlanProjectHEOptionHEOptionID","varContractPlanProjectHEOptionStatus",],{unique:true})
export class tblContractPlanProjectHEOption {
    ...
    @ManyToOne(type=>tblContractPlanProject, tblContractPlanProject=>tblContractPlanProject.tblContractPlanProjectHeOptions,{  nullable:false,onDelete: 'CASCADE', })
