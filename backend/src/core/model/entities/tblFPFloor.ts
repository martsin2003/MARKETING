...
@Index("idx_17769_IX_tblFPFloor",["bFPFloorDeletedFlg","bFPFloorIsDefaultFlg","dteFPFloorCreatedDate","dteFPFloorModifiedDate","intFPFloorFPID","intFPFloorLevel","intFPFloorOrder","varFPFloorBasePNG","varFPFloorLabel","varFPFloorPrintLabel","varFPFloorStatus",],{unique:true})
export class tblFPFloor {
    ...
    @OneToMany(type=>tblFPFloorGroup, tblFPFloorGroup=>tblFPFloorGroup.intFpFloorGroupFpFloor,{ onDelete: 'CASCADE' , })
    tblFpFloorGroups:tblFPFloorGroup[];
    

   
    @OneToMany(type=>tblFPFloorGroupOption, tblFPFloorGroupOption=>tblFPFloorGroupOption.intFpFloorGroupOptionFpFloor,{ onDelete: 'CASCADE' , })
    tblFpFloorGroupOptions:tblFPFloorGroupOption[];
    

   
    @OneToMany(type=>tblFPFloorNav, tblFPFloorNav=>tblFPFloorNav.intFpFloorNavFpFloor,{ onDelete: 'CASCADE' , })
    tblFpFloorNavs:tblFPFloorNav[];
    

   
    @OneToMany(type=>tblFPFloorOption, tblFPFloorOption=>tblFPFloorOption.intFpFloorOptionFpFloor,{ onDelete: 'CASCADE' , })
