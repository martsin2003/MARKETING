...
export class tblModel {
  ...
  @OneToMany(
    ...
    tblFPCommunityModelElevation => tblFPCommunityModelElevation.intFpCommunityModelElevationModel,
    { onDelete: 'CASCADE' }
  )
  ...
  @OneToMany(
    ...
    tblFPCommunityModelGroupGallery =>
      tblFPCommunityModelGroupGallery.intFpCommunityModelGroupGalleryModel
  )
  ...
  @OneToMany(
    ...
    tblFPCommunityModelOptionGallery =>
      tblFPCommunityModelOptionGallery.intFpCommunityModelOptionGalleryModel
  )
