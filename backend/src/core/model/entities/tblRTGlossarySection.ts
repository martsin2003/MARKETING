...
@Index("idx_20168_IX_tblRTGlossarySection",["intRTGlossarySectionDisplayOrder","intRTGlossarySectionID","varRTGlossarySectionName","varRTGlossarySectionStatus",],{unique:true})
export class tblRTGlossarySection {
    ...
    @ManyToMany(type=>tblRTGlossaryTerm, tblRTGlossaryTerm=>tblRTGlossaryTerm.tblRtGlossarySections)
