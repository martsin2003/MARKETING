...
@Index("idx_20329_IX_tblRTPaidSearchGoal",["dteRTPaidSearchGoalModifiedDate","intRTPaidSearchGoalAPIID","intRTPaidSearchGoalID","intRtPaidSearchGoalRtConfigSite","intRtPaidSearchGoalRtCredentialProvider","varRTPaidSearchGoalCategory","varRTPaidSearchGoalName","varRTPaidSearchGoalStatus",],{unique:true})
export class tblRTPaidSearchGoal {
    ...
    @ManyToOne(type=>tblRTCredentialProvider, tblRTCredentialProvider=>tblRTCredentialProvider.tblRtPaidSearchGoals,{  nullable:false,onDelete: 'CASCADE', })
    ...
    @ManyToOne(type=>tblRTConfigSite, tblRTConfigSite=>tblRTConfigSite.tblRtPaidSearchGoals,{  nullable:false,onDelete: 'CASCADE', })
    @JoinColumn({ name:'intRTPaidSearchGoalRTConfigSiteID'})
    intRtPaidSearchGoalRtConfigSite:tblRTConfigSite | null;


   
    @OneToMany(type=>tblRTPaidSearchGoalAdData, tblRTPaidSearchGoalAdData=>tblRTPaidSearchGoalAdData.intRtPaidSearchGoalAdDataRtPaidSearchGoal,{ onDelete: 'CASCADE' , })
    tblRtPaidSearchGoalAdDatas:tblRTPaidSearchGoalAdData[];
    

   
    @OneToMany(type=>tblRTPaidSearchGoalKeywordData, tblRTPaidSearchGoalKeywordData=>tblRTPaidSearchGoalKeywordData.intRtPaidSearchGoalKeywordDataRtPaidSearchGoal,{ onDelete: 'CASCADE' , })
