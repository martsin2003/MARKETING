...
@Index(
  'idx_20304_IX_tblRTPaidSearchBudget',
  [
    'curRTPaidSearchBudgetAmt',
    'intRTPaidSearchBudgetMonth',
    'intRtPaidSearchBudgetRtConfigSite',
    'intRtPaidSearchBudgetRtCredentialProvider',
    'intRTPaidSearchBudgetYear',
    'varRTPaidSearchBudgetStatus',
    'varRTPaidSearchBudgetYearType'
  ],
  { unique: true }
)
@Index('idx_20304_IX2_tblRTPaidSearchBudget', [
  'curRTPaidSearchBudgetAmt',
  'intRTPaidSearchBudgetMonth',
  'intRtPaidSearchBudgetRtCredentialProvider',
  'intRTPaidSearchBudgetYear'
...
export class tblRTPaidSearchBudget {
  ...
  @ManyToOne(type => tblRTConfigSite, tblRTConfigSite => tblRTConfigSite.tblRtPaidSearchBudgets, {
    nullable: false,
    onDelete: 'CASCADE'
  })
  ...
  @ManyToOne(
    ...
    tblRTCredentialProvider => tblRTCredentialProvider.tblRtPaidSearchBudgets,
