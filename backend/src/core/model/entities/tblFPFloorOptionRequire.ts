...
@Index(
  'idx_17872_IX_tblFPFloorOptionRequire',
  ['intFpFloorOptionRequireFpFloorOption', 'intFpFloorOptionRequireTargetFpFloorOption'],
  { unique: true }
)
export class tblFPFloorOptionRequire {
  ...
  @ManyToOne(
    ...
    tblFPFloorOption => tblFPFloorOption.tblFpFloorOptionRequires,
  ...
  @ManyToOne(
    type => tblFPFloorOption,
    tblFPFloorOption => tblFPFloorOption.tblFpFloorOptionRequires2,
    { nullable: false }
  )
