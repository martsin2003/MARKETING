...
@Index("idx_18480_IX_tblMBFLotAppointment",["bMBFLotAppointmentRequestReschedule","dteMBFLotAppointmentDate","dteMBFLotAppointmentModifiedDate","intMBFLotAppointmentID","intMBFLotAppointmentLotID","intMBFLotAppointmentPhaseID","intMBFLotAppointmentScheduledBy","intMbfLotAppointmentStatus","varMBFLotAppointmentEndTime","varMBFLotAppointmentName","varMBFLotAppointmentNameOther","varMBFLotAppointmentTime",])
@Index("idx_18480_IX2_tblMBFLotAppointment",["bMBFLotAppointmentRequestReschedule","dteMBFLotAppointmentDate","dteMBFLotAppointmentModifiedDate","intMBFLotAppointmentID","intMBFLotAppointmentID_Org","intMBFLotAppointmentLotID","intMBFLotAppointmentPhaseID","intMBFLotAppointmentScheduledBy","intMbfLotAppointmentStatus","varMBFLotAppointmentEndTime","varMBFLotAppointmentName","varMBFLotAppointmentNameOther","varMBFLotAppointmentTime",])
export class tblMBFLotAppointment {
    ...
    @ManyToOne(type=>tblMBFAppointmentStatus, tblMBFAppointmentStatus=>tblMBFAppointmentStatus.tblMbfLotAppointments,{ onDelete: 'CASCADE', })
    ...
    @OneToMany(type=>tblMBFAppointmentBuyer, tblMBFAppointmentBuyer=>tblMBFAppointmentBuyer.intMbfAppointmentBuyerAppointment,{ onDelete: 'CASCADE' , })
