...
@Index("idx_19744_IX_tblRTDisplayAd",["intRTDisplayAdAPIID","intRtDisplayAdRtDisplayAdGroup","varRTDisplayAdName","varRTDisplayAdStatus","varRTDisplayAdType",],{unique:true})
@Index("idx_19744_IX2_tblRTDisplayAd",["intRTDisplayAdAPIID","intRtDisplayAdRtDisplayAdGroup",],{unique:true})
export class tblRTDisplayAd {
    ...
    @ManyToOne(type=>tblRTDisplayAdGroup, tblRTDisplayAdGroup=>tblRTDisplayAdGroup.tblRtDisplayAds,{  nullable:false,onDelete: 'CASCADE', })
    ...
    @OneToMany(type=>tblRTDisplayAdData, tblRTDisplayAdData=>tblRTDisplayAdData.intRtDisplayAdDataRtDisplayAd,{ onDelete: 'CASCADE' , })
    tblRtDisplayAdDatas:tblRTDisplayAdData[];
    

   
    @OneToMany(type=>tblRTDisplayGAGoalAdData, tblRTDisplayGAGoalAdData=>tblRTDisplayGAGoalAdData.intRtDisplayGaGoalAdDataRtDisplayAd,{ onDelete: 'CASCADE' , })
    tblRtDisplayGaGoalAdDatas:tblRTDisplayGAGoalAdData[];
    

   
    @OneToMany(type=>tblRTDisplayGoalAdData, tblRTDisplayGoalAdData=>tblRTDisplayGoalAdData.intRtDisplayGoalAdDataRtDisplayAd,{ onDelete: 'CASCADE' , })
    tblRtDisplayGoalAdDatas:tblRTDisplayGoalAdData[];
    

   
    @OneToMany(type=>tblRTDisplayLabeledAdData, tblRTDisplayLabeledAdData=>tblRTDisplayLabeledAdData.intRtDisplayLabeledAdDataRtDisplayAd,{ onDelete: 'CASCADE' , })
