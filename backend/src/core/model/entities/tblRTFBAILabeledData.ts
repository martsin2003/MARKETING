...
@Index(
  'idx_20008_IX_tblRTFBAILabeledData',
  [
    'dteRTFBAILabeledDataEndTime',
    'intRtfbaiLabeledDataMetric',
    'intRtfbaiLabeledDataRtfbaiAd',
    'varRTFBAILabeledDataLabel'
  ],
  { unique: true }
)
export class tblRTFBAILabeledData {
  ...
  @ManyToOne(type => tblRTFBAIAd, tblRTFBAIAd => tblRTFBAIAd.tblRtfbaiLabeledDatas, {
    nullable: false,
    onDelete: 'CASCADE'
  })
  ...
  @ManyToOne(type => tblRTFBAIMetric, tblRTFBAIMetric => tblRTFBAIMetric.tblRtfbaiLabeledDatas, {
    nullable: false,
    onDelete: 'CASCADE'
  })
