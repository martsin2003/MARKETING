...
@Index("idx_18468_IX_tblMBFLot",["dteMBFLotModifiedDate","intMBFLotID","intMBFLotPhaseID","intMBFLotProjectID","varMBFLotAddress","varMBFLotCity","varMBFLotIdentifier","varMBFLotState",],{unique:true})
export class tblMBFLot {
    ...
    @OneToMany(type=>tblMBFBuyer, tblMBFBuyer=>tblMBFBuyer.intMbfBuyerLot,{ onDelete: 'CASCADE' , })
    tblMbfBuyers:tblMBFBuyer[];
    

   
    @OneToMany(type=>tblMBFLotDocument, tblMBFLotDocument=>tblMBFLotDocument.intMbfLotDocumentLot,{ onDelete: 'CASCADE' , })
    tblMbfLotDocuments:tblMBFLotDocument[];
    

   
    @OneToMany(type=>tblMBFLotEmergencyContact, tblMBFLotEmergencyContact=>tblMBFLotEmergencyContact.intMbfLotEmergencyContactLot,{ onDelete: 'CASCADE' , })
    tblMbfLotEmergencyContacts:tblMBFLotEmergencyContact[];
    

   
    @OneToMany(type=>tblMBFLotGallery, tblMBFLotGallery=>tblMBFLotGallery.intMbfLotGalleryLot,{ onDelete: 'CASCADE' , })
    tblMbfLotGallerys:tblMBFLotGallery[];
    

   
    @OneToMany(type=>tblMBFLotNotification, tblMBFLotNotification=>tblMBFLotNotification.intMbfLotNotificationLot,{ onDelete: 'CASCADE' , })
    tblMbfLotNotifications:tblMBFLotNotification[];
    

   
    @OneToMany(type=>tblMBFLotPhaseDocument, tblMBFLotPhaseDocument=>tblMBFLotPhaseDocument.intMbfLotPhaseDocumentLot,{ onDelete: 'CASCADE' , })
    tblMbfLotPhaseDocuments:tblMBFLotPhaseDocument[];
    

   
    @OneToMany(type=>tblMBFLotToDo, tblMBFLotToDo=>tblMBFLotToDo.intMbfLotToDoLot,{ onDelete: 'CASCADE' , })
    tblMbfLotToDos:tblMBFLotToDo[];
    

   
    @OneToMany(type=>tblMBFTeamMemberLot, tblMBFTeamMemberLot=>tblMBFTeamMemberLot.intMbfTeamMemberLotLot,{ onDelete: 'CASCADE' , })
