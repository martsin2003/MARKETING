...
@Index(
  'idx_16487_IX_tblAppMassMessageTemplate',
  [
    'intAppMassMessageTemplateID',
    'varAppMassMessageTemplateStatus',
    'varAppMassMessageTemplateSubject'
  ],
  { unique: true }
)
export class tblAppMassMessageTemplate {
  ...
  @OneToMany(
    ...
    tblAppMassMessage => tblAppMassMessage.intAppMassMessageTemplate,
    { onDelete: 'SET NULL' }
  )
