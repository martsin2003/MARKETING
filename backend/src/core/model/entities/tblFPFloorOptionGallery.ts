...
@Index("idx_17861_IX_tblFPFloorOptionGallery",["bFPFloorOptionGalleryDefault","bFPFloorOptionGalleryDeletedFlg","dteFPFloorOptionGalleryModifiedDate","intFpFloorOptionGalleryFpFloorOption","intFPFloorOptionGalleryModifiedBy","intFPFloorOptionGalleryNavOrder","varFPFloorOptionGalleryImageFile",],{unique:true})
export class tblFPFloorOptionGallery {
    ...
    @ManyToOne(type=>tblFPFloorOption, tblFPFloorOption=>tblFPFloorOption.tblFpFloorOptionGallerys,{  nullable:false, })
