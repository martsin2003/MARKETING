...
@Index("idx_20916_IX_tblWMSection",["intWMSectionID","intWmSectionWmProject","varWMSectionName","varWMSectionStatus",],{unique:true})
export class tblWMSection {
    ...
    @ManyToOne(type=>tblWMProject, tblWMProject=>tblWMProject.tblWmSections,{  nullable:false,onDelete: 'CASCADE', })
    ...
    @OneToMany(type=>tblWMSectionOutlyingLotMarking, tblWMSectionOutlyingLotMarking=>tblWMSectionOutlyingLotMarking.intWmSectionOutlyingLotMarkingWmSection,{ onDelete: 'CASCADE' , })
