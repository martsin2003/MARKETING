...
@Index("idx_18524_IX_tblMBFLotNotification",["dteMBFLotNotificationDueDate","dteMBFLotNotificationModifiedDate","intMBFLotNotificationID","intMbfLotNotificationLot","intMbfLotNotificationPhase","intMBFLotNotificationPhaseUpdateID","varMBFLotNotificationName","varMBFLotNotificationNameOther","varMBFLotNotificationStatus",],{unique:true})
export class tblMBFLotNotification {
    ...
    @ManyToOne(type=>tblMBFLot, tblMBFLot=>tblMBFLot.tblMbfLotNotifications,{  nullable:false,onDelete: 'CASCADE', })
    @JoinColumn({ name:'intMBFLotNotificationLotID'})
    intMbfLotNotificationLot:tblMBFLot | null;


   
    @ManyToOne(type=>tblMBFPhase, tblMBFPhase=>tblMBFPhase.tblMbfLotNotifications,{  nullable:false,onDelete: 'CASCADE', })
