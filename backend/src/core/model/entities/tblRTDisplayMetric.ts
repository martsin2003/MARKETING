...
@Index(
  'idx_19838_IX_tblRTDisplayMetric',
  [
    'bRTDisplayMetricArchivedFlg',
    'bRTDisplayMetricCollectFlg',
    'intRTDisplayMetricDivisor',
    'varRTDisplayMetricDataStoreType',
    'varRTDisplayMetricName'
  ],
  { unique: true }
)
export class tblRTDisplayMetric {
  ...
  @OneToMany(
    ...
    tblRTDisplayAdData => tblRTDisplayAdData.intRtDisplayAdDataRtDisplayMetric,
    { onDelete: 'CASCADE' }
  )
  tblRtDisplayAdDatas: tblRTDisplayAdData[];

  @OneToMany(
    type => tblRTDisplayData,
    tblRTDisplayData => tblRTDisplayData.intRtDisplayDataMetric,
    { onDelete: 'CASCADE' }
  )
  tblRtDisplayDatas: tblRTDisplayData[];

  @OneToMany(
    type => tblRTDisplayKeywordData,
    tblRTDisplayKeywordData => tblRTDisplayKeywordData.intRtDisplayKeywordDataRtDisplayMetric,
    { onDelete: 'CASCADE' }
  )
  ...
  @OneToMany(
    ...
    tblRTDisplayLabeledAdData => tblRTDisplayLabeledAdData.intRtDisplayLabeledAdDataRtDisplayMetric,
    { onDelete: 'CASCADE' }
  )
