...
@Index("idx_19782_IX_tblRTDisplayGAGoalAdData",["dteRTDisplayGAGoalAdDataDate","intRtDisplayGaGoalAdDataRtDisplayAd","intRtDisplayGaGoalAdDataRtgaGoal","intRTDisplayGAGoalAdDataValue",],{unique:true})
@Index("idx_19782_IX2_tblRTDisplayGAGoalAdData",["dteRTDisplayGAGoalAdDataDate","intRTDisplayGAGoalAdDataID","intRtDisplayGaGoalAdDataRtDisplayAd","intRtDisplayGaGoalAdDataRtgaGoal","intRTDisplayGAGoalAdDataValue",])
export class tblRTDisplayGAGoalAdData {
    ...
    @ManyToOne(type=>tblRTDisplayAd, tblRTDisplayAd=>tblRTDisplayAd.tblRtDisplayGaGoalAdDatas,{  nullable:false,onDelete: 'CASCADE', })
    @JoinColumn({ name:'intRTDisplayGAGoalAdDataRTDisplayAdID'})
    intRtDisplayGaGoalAdDataRtDisplayAd:tblRTDisplayAd | null;


   
    @ManyToOne(type=>tblRTGAGoal, tblRTGAGoal=>tblRTGAGoal.tblRtDisplayGaGoalAdDatas,{  nullable:false, })
