...
@Index(
  'idx_18293_IX_tblMBFAppointmentBuyer',
  [
    'dteMBFAppointmentBuyerModifiedDate',
    'intMbfAppointmentBuyerAppointment',
    'intMbfAppointmentBuyerBuyer',
    'intMBFAppointmentBuyerID',
    'intMbfAppointmentBuyerStatus'
  ],
  { unique: true }
)
export class tblMBFAppointmentBuyer {
  ...
  @ManyToOne(
    ...
    tblMBFLotAppointment => tblMBFLotAppointment.tblMbfAppointmentBuyers,
    { nullable: false, onDelete: 'CASCADE' }
  )
  @JoinColumn({ name: 'intMBFAppointmentBuyerAppointmentID' })
  intMbfAppointmentBuyerAppointment: tblMBFLotAppointment | null;

  @ManyToOne(type => tblMBFBuyer, tblMBFBuyer => tblMBFBuyer.tblMbfAppointmentBuyers, {
    nullable: false,
    onDelete: 'CASCADE'
  })
  ...
  @ManyToOne(
    type => tblMBFAppointmentBuyerStatus,
    tblMBFAppointmentBuyerStatus => tblMBFAppointmentBuyerStatus.tblMbfAppointmentBuyers,
    { nullable: false, onDelete: 'CASCADE' }
  )
