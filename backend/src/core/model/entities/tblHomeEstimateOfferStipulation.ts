...
export class tblHomeEstimateOfferStipulation {
    ...
    @OneToMany(type=>tblHomeEstimateOfferStipulationXRef, tblHomeEstimateOfferStipulationXRef=>tblHomeEstimateOfferStipulationXRef.intHomeEstimateOfferStipulation,{ onDelete: 'CASCADE' , })
