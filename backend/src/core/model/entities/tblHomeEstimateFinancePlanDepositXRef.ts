...
@Index("idx_18075_IX_tblHomeEstimateFinancePlanDepositXRef",["intDeposit","intHomeEstimateFinancePlanXRefID",],{unique:true})
export class tblHomeEstimateFinancePlanDepositXRef {
    ...
    @ManyToOne(type=>tblHomeEstimateFinancePlanDeposit, tblHomeEstimateFinancePlanDeposit=>tblHomeEstimateFinancePlanDeposit.tblHomeEstimateFinancePlanDepositXRefs,{ onDelete: 'CASCADE', })
