...
export class tblRTConfigSite {
  ...
  @OneToMany(
    ...
    tblRTConfigSiteCampaign => tblRTConfigSiteCampaign.intRtConfigSiteCampaignRtConfigSite,
    { onDelete: 'CASCADE' }
  )
  ...
  @OneToMany(
    ...
    tblRTDisplayGoal => tblRTDisplayGoal.intRtDisplayGoalRtConfigSite,
    { onDelete: 'CASCADE' }
  )
  ...
  @OneToMany(
    ...
    tblRTEmailMarketingItem => tblRTEmailMarketingItem.intRtEmailMarketingItemRtConfigSite,
    { onDelete: 'CASCADE' }
  )
  ...
  @OneToMany(
    ...
    tblRTPaidSearchBudget => tblRTPaidSearchBudget.intRtPaidSearchBudgetRtConfigSite,
    { onDelete: 'CASCADE' }
  )
  ...
  @OneToMany(
    ...
    tblRTPaidSearchGoal => tblRTPaidSearchGoal.intRtPaidSearchGoalRtConfigSite,
    { onDelete: 'CASCADE' }
  )
