...
@Index("idx_19788_IX_tblRTDisplayGoal",["dteRTDisplayGoalModifiedDate","intRTDisplayGoalAPIID","intRTDisplayGoalID","intRtDisplayGoalRtConfigSite","intRtDisplayGoalRtCredentialProvider","varRTDisplayGoalCategory","varRTDisplayGoalName","varRTDisplayGoalStatus",],{unique:true})
export class tblRTDisplayGoal {
    ...
    @ManyToOne(type=>tblRTCredentialProvider, tblRTCredentialProvider=>tblRTCredentialProvider.tblRtDisplayGoals,{  nullable:false,onDelete: 'CASCADE', })
    @JoinColumn({ name:'intRTDisplayGoalRTCredentialProviderID'})
    intRtDisplayGoalRtCredentialProvider:tblRTCredentialProvider | null;


   
    @ManyToOne(type=>tblRTConfigSite, tblRTConfigSite=>tblRTConfigSite.tblRtDisplayGoals,{  nullable:false,onDelete: 'CASCADE', })
    @JoinColumn({ name:'intRTDisplayGoalRTConfigSiteID'})
    intRtDisplayGoalRtConfigSite:tblRTConfigSite | null;


   
    @OneToMany(type=>tblRTDisplayGoalAdData, tblRTDisplayGoalAdData=>tblRTDisplayGoalAdData.intRtDisplayGoalAdDataRtDisplayGoal,{ onDelete: 'CASCADE' , })
    tblRtDisplayGoalAdDatas:tblRTDisplayGoalAdData[];
    

   
    @OneToMany(type=>tblRTDisplayGoalKeywordData, tblRTDisplayGoalKeywordData=>tblRTDisplayGoalKeywordData.intRtDisplayGoalKeywordDataRtDisplayGoal,{ onDelete: 'CASCADE' , })
