...
@Index("idx_18503_IX_tblMBFLotEmergencyContact",["intMbfLotEmergencyContactLot","intMBFLotEmergencyContactSubcontractorID","intMBFLotEmergencyContactTypeID","varMBFLotEmergencyContactPhone","varMBFLotEmergencyContactPhone2","varMBFLotEmergencyContactWebsite",],{unique:true})
export class tblMBFLotEmergencyContact {
    ...
    @ManyToOne(type=>tblMBFLot, tblMBFLot=>tblMBFLot.tblMbfLotEmergencyContacts,{  nullable:false,onDelete: 'CASCADE', })
