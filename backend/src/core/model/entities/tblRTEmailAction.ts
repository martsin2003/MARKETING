...
export class tblRTEmailAction {
  ...
  @OneToMany(
    type => tblRTEmailUserEmailAction,
    tblRTEmailUserEmailAction => tblRTEmailUserEmailAction.intRtEmailUserEmailActionAction,
    { onDelete: 'CASCADE' }
  )
  ...
  @OneToMany(
    ...
    tblRTEmailUserSummary => tblRTEmailUserSummary.intRtEmailUserSummaryEmailAction,
    { onDelete: 'CASCADE' }
  )
