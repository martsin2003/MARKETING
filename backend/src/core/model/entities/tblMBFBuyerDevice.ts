...
export class tblMBFBuyerDevice {
    ...
    @ManyToOne(type=>tblMBFBuyer, tblMBFBuyer=>tblMBFBuyer.tblMbfBuyerDevices,{ primary:true, nullable:false,onDelete: 'CASCADE', })
    @JoinColumn({ name:'intMBFBuyerDeviceMBFBuyerID'})
    intMbfBuyerDeviceMbfBuyer:tblMBFBuyer | null;


   
    @ManyToOne(type=>tblMBFDevice, tblMBFDevice=>tblMBFDevice.tblMbfBuyerDevices,{ primary:true, nullable:false,onDelete: 'CASCADE', })
