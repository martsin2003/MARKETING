...
@Index("idx_17797_IX_tblFPFloorGroupGallery",["bFPFloorGroupGalleryDefault","bFPFloorGroupGalleryDeletedFlg","dteFPFloorGroupGalleryModifiedDate","intFpFloorGroupGalleryFpFloorGroup","intFPFloorGroupGalleryModifiedBy","intFPFloorGroupGalleryNavOrder","varFPFloorGroupGalleryImageFile",],{unique:true})
export class tblFPFloorGroupGallery {
    ...
    @ManyToOne(type=>tblFPFloorGroup, tblFPFloorGroup=>tblFPFloorGroup.tblFpFloorGroupGallerys,{  nullable:false, })
