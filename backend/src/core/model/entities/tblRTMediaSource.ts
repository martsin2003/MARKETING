...
@Index(
  'idx_20244_IX_tblRTMediaSource',
  [
    'bRTMediaSourceAddedBy3rdPartyListingFlg',
    'bRTMediaSourceArchivedFlg',
    'intRtMediaSourceAdvertisingSource',
    'intRtMediaSourceAdvertisingType',
    'intRTMediaSourceMediaCompanyContactID',
    'intRTMediaSourceMediaCompanyID',
    'varRTMediaSourceName',
    'varRTMediaSourceStatus'
  ],
  { unique: true }
)
export class tblRTMediaSource {
  ...
  @ManyToOne(
    type => tblRTAdvertisingType,
    tblRTAdvertisingType => tblRTAdvertisingType.tblRtMediaSources,
  ...
  @ManyToOne(
    ...
    tblRTAdvertisingSource => tblRTAdvertisingSource.tblRtMediaSources,
    { nullable: false, onDelete: 'CASCADE' }
  )
  ...
  @OneToMany(
    ...
    tblRTDisplayAdGroupMediaSource =>
      tblRTDisplayAdGroupMediaSource.intRtDisplayAdGroupMediaSourceRtMediaSource,
    { onDelete: 'CASCADE' }
  )
  ...
  @OneToMany(
    ...
    tblRTDisplayNonAPIAdData => tblRTDisplayNonAPIAdData.intRtDisplayNonApiAdDataRtMediaSource,
    { onDelete: 'CASCADE' }
  )
  ...
  @OneToMany(
    ...
    tblRTDisplayNonAPIGoalData =>
      tblRTDisplayNonAPIGoalData.intRtDisplayNonApiGoalDataRtMediaSource,
    { onDelete: 'CASCADE' }
  )
  ...
  @OneToMany(
    ...
    tblRTEmailMarketingItem => tblRTEmailMarketingItem.intRtEmailMarketingItemRtMediaSource,
    { onDelete: 'CASCADE' }
  )
