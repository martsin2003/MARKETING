...
@Index(
  'idx_19930_IX_tblRTEmailMarketingItemGAGoalData',
  [
    'intRTEmailMarketingItemGAGoalDataID',
    'intRtEmailMarketingItemGaGoalDataRtEmailMarketingItem',
    'intRtEmailMarketingItemGaGoalDataRtgaGoal',
    'intRTEmailMarketingItemGAGoalDataValue'
  ],
  { unique: true }
)
export class tblRTEmailMarketingItemGAGoalData {
  ...
  @ManyToOne(
    ...
    tblRTEmailMarketingItem => tblRTEmailMarketingItem.tblRtEmailMarketingItemGaGoalDatas,
  ...
  @ManyToOne(type => tblRTGAGoal, tblRTGAGoal => tblRTGAGoal.tblRtEmailMarketingItemGaGoalDatas, {
    nullable: false
  })
