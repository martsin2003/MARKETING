...
export class tblPaperSpec {
    ...
    @ManyToOne(type=>tblContractPlanContractPlanProjectXRef, tblContractPlanContractPlanProjectXRef=>tblContractPlanContractPlanProjectXRef.tblPaperSpecs,{  nullable:false,onDelete: 'CASCADE', })
    ...
    @OneToMany(type=>tblPaperSpecHomesite, tblPaperSpecHomesite=>tblPaperSpecHomesite.intPaperSpecHomesitePaperSpec,{ onDelete: 'CASCADE' , })
    tblPaperSpecHomesites:tblPaperSpecHomesite[];
    

   
    @OneToMany(type=>tblPaperSpecOption, tblPaperSpecOption=>tblPaperSpecOption.intPaperSpecOptionPaperSpec,{ onDelete: 'CASCADE' , })
