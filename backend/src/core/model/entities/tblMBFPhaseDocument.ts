...
@Index(
  'idx_18634_IX_tblMBFPhaseDocument',
  [
    'dteMBFPhaseDocumentModifiedDate',
    'intMBFPhaseDocumentCategoryID',
    'intMBFPhaseDocumentID',
    'intMBFPhaseDocumentPhaseID',
    'varMBFPhaseDocumentName',
    'varMBFPhaseDocumentStatus'
  ],
  { unique: true }
)
export class tblMBFPhaseDocument {
  ...
  @OneToMany(
    ...
    tblMBFLotPhaseDocument => tblMBFLotPhaseDocument.intMbfLotPhaseDocumentDocument,
    { onDelete: 'CASCADE' }
  )
