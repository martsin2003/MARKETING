...
@Index('idx_19670_IX2_tblRTConfigSiteCampaign', [
  'intRtConfigSiteCampaignRtCampaign',
  'intRtConfigSiteCampaignRtConfigSite'
])
export class tblRTConfigSiteCampaign {
  ...
  @ManyToOne(type => tblRTConfigSite, tblRTConfigSite => tblRTConfigSite.tblRtConfigSiteCampaigns, {
    nullable: false,
    onDelete: 'CASCADE'
  })
  ...
  @ManyToOne(type => tblRTCampaign, tblRTCampaign => tblRTCampaign.tblRtConfigSiteCampaigns, {
    nullable: false,
    onDelete: 'CASCADE'
  })
