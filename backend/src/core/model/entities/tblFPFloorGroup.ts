...
export class tblFPFloorGroup {
    ...
    @ManyToOne(type=>tblFPFloor, tblFPFloor=>tblFPFloor.tblFpFloorGroups,{  nullable:false,onDelete: 'CASCADE', })
    ...
    @OneToMany(type=>tblFPCommunityModelElevationGroupGallery, tblFPCommunityModelElevationGroupGallery=>tblFPCommunityModelElevationGroupGallery.intFpCommunityModelElevationGroupGalleryFpFloorGroup)
    tblFpCommunityModelElevationGroupGallerys:tblFPCommunityModelElevationGroupGallery[];
    

   
    @OneToMany(type=>tblFPCommunityModelGroupGallery, tblFPCommunityModelGroupGallery=>tblFPCommunityModelGroupGallery.intFpCommunityModelGroupGalleryFpFloorGroup)
    tblFpCommunityModelGroupGallerys:tblFPCommunityModelGroupGallery[];
    

   
    @OneToMany(type=>tblFPFloorGroupGallery, tblFPFloorGroupGallery=>tblFPFloorGroupGallery.intFpFloorGroupGalleryFpFloorGroup)
    tblFpFloorGroupGallerys:tblFPFloorGroupGallery[];
    

   
    @OneToMany(type=>tblFPFloorGroupOption, tblFPFloorGroupOption=>tblFPFloorGroupOption.intFpFloorGroupOptionFpFloorGroup)
    ...
    @OneToMany(type=>tblFPModelGenericElevationGroupGallery, tblFPModelGenericElevationGroupGallery=>tblFPModelGenericElevationGroupGallery.intFpModelGenericElevationGroupGalleryFpFloorGroup)
