...
@Index("idx_18426_IX_tblMBFDocumentConfig",["intMBFDocumentConfigID","varMBFDocumentConfigDescription","varMBFDocumentConfigStatus","varMBFDocumentConfigTitle",],{unique:true})
