...
@Index("idx_18540_IX_tblMBFLotToDo",["bMBFLotToDoCompleted","dteMBFLotToDoDueDate","dteMBFLotToDoModifiedDate","intMBFLotToDoID","intMbfLotToDoLot","intMbfLotToDoPhase","intMBFLotToDoPhaseToDoID","varMBFLotToDoName","varMBFLotToDoNameOther","varMBFLotToDoStatus",])
export class tblMBFLotToDo {
    ...
    @ManyToOne(type=>tblMBFLot, tblMBFLot=>tblMBFLot.tblMbfLotToDos,{  nullable:false,onDelete: 'CASCADE', })
    @JoinColumn({ name:'intMBFLotToDoLotID'})
    intMbfLotToDoLot:tblMBFLot | null;


   
    @ManyToOne(type=>tblMBFPhase, tblMBFPhase=>tblMBFPhase.tblMbfLotToDos,{  nullable:false,onDelete: 'CASCADE', })
    ...
    @OneToMany(type=>tblMBFLotToDoAssociation, tblMBFLotToDoAssociation=>tblMBFLotToDoAssociation.intMbfLotToDoAssociationToDo,{ onDelete: 'CASCADE' , })
    tblMbfLotToDoAssociations:tblMBFLotToDoAssociation[];
    

   
    @OneToMany(type=>tblMBFLotToDoDependency, tblMBFLotToDoDependency=>tblMBFLotToDoDependency.intMbfLotToDoDependencyToDoDependent,{ onDelete: 'CASCADE' , })
