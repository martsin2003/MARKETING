...
@Index('idx_20292_IX2_tblRTPaidSearchAdGroup', [
  'intRTPaidSearchAdGroupAPIID',
  'intRTPaidSearchAdGroupID',
  'intRtPaidSearchAdGroupRtCampaign',
  'varRTPaidSearchAdGroupStatus'
])
@Index(
  'idx_20292_IX_tblRTPaidSearchAdGroup',
  [
    'intRTPaidSearchAdGroupAPIID',
    'intRtPaidSearchAdGroupRtCampaign',
    'varRTPaidSearchAdGroupName',
    'varRTPaidSearchAdGroupStatus'
  ],
  { unique: true }
)
export class tblRTPaidSearchAdGroup {
  ...
  @ManyToOne(type => tblRTCampaign, tblRTCampaign => tblRTCampaign.tblRtPaidSearchAdGroups, {
    nullable: false,
    onDelete: 'CASCADE'
  })
  ...
  @OneToMany(
    ...
    tblRTPaidSearchAd => tblRTPaidSearchAd.intRtPaidSearchAdRtPaidSearchAdGroup,
    { onDelete: 'CASCADE' }
  )
  ...
  @OneToMany(
    ...
    tblRTPaidSearchKeyword => tblRTPaidSearchKeyword.intRtPaidSearchKeywordRtPaidSearchAdGroup,
    { onDelete: 'CASCADE' }
  )
