...
@Index("idx_20346_IX_tblRTPaidSearchGoalCampaignData",["dteRTPaidSearchGoalCampaignDataDate","intRtPaidSearchGoalCampaignDataRtCampaign","intRtPaidSearchGoalCampaignDataRtgaGoal","intRTPaidSearchGoalCampaignDataValue",],{unique:true})
@Index("idx_20346_IX2_tblRTPaidSearchGoalCampaignData",["dteRTPaidSearchGoalCampaignDataDate","intRTPaidSearchGoalCampaignDataValue",])
export class tblRTPaidSearchGoalCampaignData {
    ...
    @ManyToOne(type=>tblRTCampaign, tblRTCampaign=>tblRTCampaign.tblRtPaidSearchGoalCampaignDatas,{  nullable:false,onDelete: 'CASCADE', })
    @JoinColumn({ name:'intRTPaidSearchGoalCampaignDataRTCampaignID'})
    intRtPaidSearchGoalCampaignDataRtCampaign:tblRTCampaign | null;


   
    @ManyToOne(type=>tblRTGAGoal, tblRTGAGoal=>tblRTGAGoal.tblRtPaidSearchGoalCampaignDatas,{  nullable:false, })
