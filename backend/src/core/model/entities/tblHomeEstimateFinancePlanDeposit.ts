...
export class tblHomeEstimateFinancePlanDeposit {
  ...
  @ManyToOne(
    type => tblDepositType,
    tblDepositType => tblDepositType.tblHomeEstimateFinancePlanDeposits,
    { onDelete: 'SET NULL' }
  )
  ...
  @ManyToOne(
    type => tblDepositPmntMethod,
    tblDepositPmntMethod => tblDepositPmntMethod.tblHomeEstimateFinancePlanDeposits,
    { onDelete: 'SET NULL' }
  )
  ...
  @OneToMany(
    type => tblHomeEstimateFinancePlanDepositXRef,
    tblHomeEstimateFinancePlanDepositXRef => tblHomeEstimateFinancePlanDepositXRef.intDeposit,
    { onDelete: 'CASCADE' }
  )
