...
export class tblRTGAGoal {
    ...
    @ManyToOne(type=>tblRTCampaign, tblRTCampaign=>tblRTCampaign.tblRtgaGoals,{  nullable:false,onDelete: 'CASCADE', })
    ...
    @OneToMany(type=>tblRTDisplayGAGoalAdData, tblRTDisplayGAGoalAdData=>tblRTDisplayGAGoalAdData.intRtDisplayGaGoalAdDataRtgaGoal)
    tblRtDisplayGaGoalAdDatas:tblRTDisplayGAGoalAdData[];
    

   
    @OneToMany(type=>tblRTDisplayNonAPIGoalData, tblRTDisplayNonAPIGoalData=>tblRTDisplayNonAPIGoalData.intRtDisplayNonApiGoalDataRtgaGoal,{ onDelete: 'CASCADE' , })
    tblRtDisplayNonApiGoalDatas:tblRTDisplayNonAPIGoalData[];
    

   
    @OneToMany(type=>tblRTEmailMarketingItemGAGoalData, tblRTEmailMarketingItemGAGoalData=>tblRTEmailMarketingItemGAGoalData.intRtEmailMarketingItemGaGoalDataRtgaGoal)
    tblRtEmailMarketingItemGaGoalDatas:tblRTEmailMarketingItemGAGoalData[];
    

   
    @OneToMany(type=>tblRTGAGoalData, tblRTGAGoalData=>tblRTGAGoalData.intRtgaGoalDataRtgaGoal,{ onDelete: 'CASCADE' , })
    tblRtgaGoalDatas:tblRTGAGoalData[];
    

   
    @OneToMany(type=>tblRTGAGoalLabeledData, tblRTGAGoalLabeledData=>tblRTGAGoalLabeledData.intRtgaGoalLabeledDataRtgaGoal,{ onDelete: 'CASCADE' , })
    tblRtgaGoalLabeledDatas:tblRTGAGoalLabeledData[];
    

   
    @OneToMany(type=>tblRTPaidSearchGAGoalAdData, tblRTPaidSearchGAGoalAdData=>tblRTPaidSearchGAGoalAdData.intRtPaidSearchGaGoalAdDataRtgaGoal)
    tblRtPaidSearchGaGoalAdDatas:tblRTPaidSearchGAGoalAdData[];
    

   
    @OneToMany(type=>tblRTPaidSearchGoalCampaignData, tblRTPaidSearchGoalCampaignData=>tblRTPaidSearchGoalCampaignData.intRtPaidSearchGoalCampaignDataRtgaGoal)
    tblRtPaidSearchGoalCampaignDatas:tblRTPaidSearchGoalCampaignData[];
    

   
    @OneToMany(type=>tblRTPaidSearchGoalKeywordNonAdwordsData, tblRTPaidSearchGoalKeywordNonAdwordsData=>tblRTPaidSearchGoalKeywordNonAdwordsData.intRtPaidSearchGoalKeywordNonAdwordsDataRtgaGoal)
