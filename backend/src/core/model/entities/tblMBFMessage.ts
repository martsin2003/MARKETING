...
@Index("idx_18563_IX_tblMBFMessage",["bMBFMessageUrgentFlg","dteMBFMessageCreatedDate","dteMBFMessageModifiedDate","intMBFMessageInitialMBFTeamMemberID","intMbfMessageMbfBuyer","varMBFMessageEmailMessageID","varMBFMessageNonce","varMBFMessagePublicID","varMBFMessageStatus","varMBFMessageSubject",],{unique:true})
@Index("idx_18563_IX2_tblMBFMessage",["dteMBFMessageModifiedDate","intMBFMessageID","varMBFMessageStatus",])
export class tblMBFMessage {
    ...
    @ManyToOne(type=>tblMBFBuyer, tblMBFBuyer=>tblMBFBuyer.tblMbfMessages,{  nullable:false,onDelete: 'CASCADE', })
    ...
    @OneToMany(type=>tblMBFMessageEscalationLog, tblMBFMessageEscalationLog=>tblMBFMessageEscalationLog.intMbfMessageEscalationLogMbfMessage,{ onDelete: 'CASCADE' , })
    tblMbfMessageEscalationLogs:tblMBFMessageEscalationLog[];
    

   
    @OneToMany(type=>tblMBFMessageResolution, tblMBFMessageResolution=>tblMBFMessageResolution.intMbfMessageResolutionMbfMessage,{ onDelete: 'CASCADE' , })
    tblMbfMessageResolutions:tblMBFMessageResolution[];
    

   
    @OneToMany(type=>tblMBFMessageThread, tblMBFMessageThread=>tblMBFMessageThread.intMbfMessageThreadMbfMessage,{ onDelete: 'CASCADE' , })
