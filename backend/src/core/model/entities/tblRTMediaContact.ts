...
@Index(
  'idx_20231_IX_tblRTMediaContact',
  [
    'bRTMediaContactArchivedFlg',
    'intRTMediaContactNDGClientContactID',
    'intRTMediaContactNDGCompanyID',
    'varRTMediaContactEmail',
    'varRTMediaContactFirstName',
    'varRTMediaContactLastName',
    'varRTMediaContactPhone',
    'varRTMediaContactStatus',
    'varRTMediaContactType'
  ],
  { unique: true }
)
