...
export class tblContactAutomatedEmailSent {
    ...
    @ManyToOne(type=>tblContact, tblContact=>tblContact.tblContactAutomatedEmailSents,{  nullable:false,onDelete: 'CASCADE', })
    @JoinColumn({ name:'intContactAutomatedEmailSentContactID'})
    intContactAutomatedEmailSentContact:tblContact | null;


   
    @ManyToOne(type=>tblContactAutomatedEmail, tblContactAutomatedEmail=>tblContactAutomatedEmail.tblContactAutomatedEmailSents,{  nullable:false,onDelete: 'CASCADE', })
