...
@Index("idx_17637_IX_tblFPCommunityModelElevationOptionDesc",["bFPCommunityModelElevationOptionDescDeletedFlg","intFpCommunityModelElevationOptionDescFpCommunityModelElevation","intFpCommunityModelElevationOptionDescFpFloorOption","varFPCommunityModelElevationOptionDescStatus",],{unique:true})
export class tblFPCommunityModelElevationOptionDesc {
    ...
    @ManyToOne(type=>tblFPCommunityModelElevation, tblFPCommunityModelElevation=>tblFPCommunityModelElevation.tblFpCommunityModelElevationOptionDescs,{ onDelete: 'CASCADE', })
    ...
    @ManyToOne(type=>tblFPFloorOption, tblFPFloorOption=>tblFPFloorOption.tblFpCommunityModelElevationOptionDescs,{  nullable:false, })
