...
@Index("idx_20862_IX_tblWMProject",["intWMProjectCommunityProjectID","intWMProjectID","intWmProjectWmCommunity","varWMProjectStatus",],{unique:true})
export class tblWMProject {
    ...
    @ManyToOne(type=>tblWMCommunity, tblWMCommunity=>tblWMCommunity.tblWmProjects,{  nullable:false,onDelete: 'CASCADE', })
    ...
    @OneToMany(type=>tblAppLocationMasterTemplateAssignment, tblAppLocationMasterTemplateAssignment=>tblAppLocationMasterTemplateAssignment.intAppLocationMasterTemplateAssignmentWmProject,{ onDelete: 'CASCADE' , })
    tblAppLocationMasterTemplateAssignments:tblAppLocationMasterTemplateAssignment[];
    

   
    @OneToMany(type=>tblAppLocationTemplate, tblAppLocationTemplate=>tblAppLocationTemplate.intAppLocationTemplateWmProject,{ onDelete: 'CASCADE' , })
    tblAppLocationTemplates:tblAppLocationTemplate[];
    

   
    @OneToMany(type=>tblWMSection, tblWMSection=>tblWMSection.intWmSectionWmProject,{ onDelete: 'CASCADE' , })
