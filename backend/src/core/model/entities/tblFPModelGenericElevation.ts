...
export class tblFPModelGenericElevation {
  ...
  @OneToMany(
    ...
    tblFPModelGenericElevationGroupGallery =>
      tblFPModelGenericElevationGroupGallery.intFpModelGenericElevationGroupGalleryFpModelGenericElevation
  )
  ...
  @OneToMany(
    ...
    tblFPModelGenericElevationOptionGallery =>
      tblFPModelGenericElevationOptionGallery.intFpModelGenericElevationOptionGalleryFpModelGenericElevationI
  )
