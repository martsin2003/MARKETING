...
@Index(
  'idx_18716_IX_tblMBFTeamMemberCommunityProject',
  ['intMBFTeamMemberCommunityProjectProjectID', 'intMbfTeamMemberCommunityProjectTeamMember'],
  { unique: true }
)
export class tblMBFTeamMemberCommunityProject {
  ...
  @ManyToOne(
    ...
    tblMBFTeamMember => tblMBFTeamMember.tblMbfTeamMemberCommunityProjects,
