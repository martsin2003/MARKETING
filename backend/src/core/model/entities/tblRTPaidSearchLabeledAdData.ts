...
@Index("idx_20382_IX_tblRTPaidSearchLabeledAdData",["dteRTPaidSearchLabeledAdDataCreatedDate","dteRTPaidSearchLabeledAdDataEndTime","intRTPaidSearchLabeledAdDataID","intRtPaidSearchLabeledAdDataRtPaidSearchAd","intRtPaidSearchLabeledAdDataRtPaidSearchMetric","varRTPaidSearchLabeledAdDataLabel",])
@Index("idx_20382_IX2_tblRTPaidSearchLabeledAdData",["dteRTPaidSearchLabeledAdDataEndTime","intRtPaidSearchLabeledAdDataRtPaidSearchAd","intRtPaidSearchLabeledAdDataRtPaidSearchMetric","intRTPaidSearchLabeledAdDataValue","varRTPaidSearchLabeledAdDataLabel",])
export class tblRTPaidSearchLabeledAdData {
    ...
    @ManyToOne(type=>tblRTPaidSearchAd, tblRTPaidSearchAd=>tblRTPaidSearchAd.tblRtPaidSearchLabeledAdDatas,{  nullable:false,onDelete: 'CASCADE', })
    ...
    @ManyToOne(type=>tblRTPaidSearchMetric, tblRTPaidSearchMetric=>tblRTPaidSearchMetric.tblRtPaidSearchLabeledAdDatas,{  nullable:false,onDelete: 'CASCADE', })
