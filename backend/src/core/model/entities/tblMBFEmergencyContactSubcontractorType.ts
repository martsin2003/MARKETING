...
@Index(
  'idx_18444_IX_tblMBFEmergencyContactSubcontractorType',
  [
    'intMbfEmergencyContactSubcontractorTypeSubcontractor',
    'intMBFEmergencyContactSubcontractorTypeTypeID'
  ],
  { unique: true }
)
export class tblMBFEmergencyContactSubcontractorType {
  @ManyToOne(
    type => tblMBFEmergencyContactSubcontractor,
    tblMBFEmergencyContactSubcontractor =>
      tblMBFEmergencyContactSubcontractor.tblMbfEmergencyContactSubcontractorTypes,
