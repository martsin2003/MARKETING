...
@Index(
  'idx_18583_IX_tblMBFMessageResolution',
  [
    'bMBFMessageResolutionResolvedByClientFlg',
    'intMbfMessageResolutionMbfMessage',
    'intMBFMessageResolutionMBFTeamMemberID',
    'varMBFMessageResolutionResolvedBy'
  ],
  { unique: true }
)
@Index('idx_18583_IX_tblMBFMessageResolution2', [
  'bMBFMessageResolutionResolvedByClientFlg',
  'dteMBFMessageResolutionCreatedDate',
  'intMbfMessageResolutionMbfMessage',
  'intMBFMessageResolutionMBFTeamMemberID',
  'varMBFMessageResolutionResolvedBy'
])
export class tblMBFMessageResolution {
  ...
  @ManyToOne(type => tblMBFMessage, tblMBFMessage => tblMBFMessage.tblMbfMessageResolutions, {
    nullable: false,
    onDelete: 'CASCADE'
  })
