...
@Index(
  'idx_17480_IX_tblEmpowerAboutGallery',
  [
    'intEmpowerAboutGalleryID',
    'intEmpowerAboutGallerySequence',
    'varEmpowerAboutGalleryCaption',
    'varEmpowerAboutGalleryFilename',
    'varEmpowerAboutGalleryStatus'
  ],
  { unique: true }
)
