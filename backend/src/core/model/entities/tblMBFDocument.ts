...
@Index(
  'idx_18415_IX_tblMBFDocument',
  ['intMbfDocumentCategory', 'varMBFDocumentName', 'varMBFDocumentState', 'varMBFDocumentStatus'],
  { unique: true }
)
export class tblMBFDocument {
  ...
  @ManyToOne(type => tblMBFCategory, tblMBFCategory => tblMBFCategory.tblMbfDocuments, {
    nullable: false,
    onDelete: 'CASCADE'
  })
