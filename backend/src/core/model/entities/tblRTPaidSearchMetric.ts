...
@Index("idx_20391_IX_tblRTPaidSearchMetric",["bRTPaidSearchMetricArchivedFlg","bRTPaidSearchMetricCollectFlg","intRTPaidSearchMetricDivisor","intRTPaidSearchMetricID","varRTPaidSearchMetricDataStoreType","varRTPaidSearchMetricName",],{unique:true})
export class tblRTPaidSearchMetric {
    ...
    @OneToMany(type=>tblRTPaidSearchAdData, tblRTPaidSearchAdData=>tblRTPaidSearchAdData.intRtPaidSearchAdDataRtPaidSearchMetric,{ onDelete: 'CASCADE' , })
    tblRtPaidSearchAdDatas:tblRTPaidSearchAdData[];
    

   
    @OneToMany(type=>tblRTPaidSearchCampaignData, tblRTPaidSearchCampaignData=>tblRTPaidSearchCampaignData.intRtPaidSearchCampaignDataRtPaidSearchMetric,{ onDelete: 'CASCADE' , })
    tblRtPaidSearchCampaignDatas:tblRTPaidSearchCampaignData[];
    

   
    @OneToMany(type=>tblRTPaidSearchKeywordData, tblRTPaidSearchKeywordData=>tblRTPaidSearchKeywordData.intRtPaidSearchKeywordDataRtPaidSearchMetric,{ onDelete: 'CASCADE' , })
    tblRtPaidSearchKeywordDatas:tblRTPaidSearchKeywordData[];
    

   
    @OneToMany(type=>tblRTPaidSearchLabeledAdData, tblRTPaidSearchLabeledAdData=>tblRTPaidSearchLabeledAdData.intRtPaidSearchLabeledAdDataRtPaidSearchMetric,{ onDelete: 'CASCADE' , })
