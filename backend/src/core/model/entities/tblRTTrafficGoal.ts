...
export class tblRTTrafficGoal {
    ...
    @OneToMany(type=>tblRTTrafficGoalCommunityGoal, tblRTTrafficGoalCommunityGoal=>tblRTTrafficGoalCommunityGoal.intRtTrafficGoalCommunityGoalGoal,{ onDelete: 'CASCADE' , })
