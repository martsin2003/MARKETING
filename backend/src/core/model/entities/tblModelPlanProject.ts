...
@Index("idx_18904_IX_tblModelPlanProject",["intModelPlanProjectCommunityProject","intModelPlanProjectModelGenericID","intModelPlanProjectModelID","varModelPlanProjectPlanCode","varModelPlanProjectPlanProjectHash","varModelPlanProjectProjectCode",],{unique:true})
export class tblModelPlanProject {
    ...
    @ManyToOne(type=>tblCommunityProject, tblCommunityProject=>tblCommunityProject.tblModelPlanProjects,{  })
    ...
    @OneToMany(type=>tblHomeEstimate, tblHomeEstimate=>tblHomeEstimate.intHomeEstimateModelPlanProject)
    tblHomeEstimates:tblHomeEstimate[];
    

   
    @OneToMany(type=>tblModelPlanProjectHEOption, tblModelPlanProjectHEOption=>tblModelPlanProjectHEOption.intModelPlanProjectHeOptionModelPlanProject)
