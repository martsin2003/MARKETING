...
@Index("idx_20181_IX_tblRTGlossaryTerm",["intRTGlossaryTermID","varRTGlossaryTerm","varRTGlossaryTermStatus",],{unique:true})
export class tblRTGlossaryTerm {
    ...
    @ManyToMany(type=>tblRTGlossarySection, tblRTGlossarySection=>tblRTGlossarySection.tblRtGlossaryTerms,{  nullable:false, })
