...
@Index("idx_16436_IX_tblAppLocationMasterTemplate",["intAppLocationMasterTemplateID","varAppLocationMasterTemplateAddress","varAppLocationMasterTemplateCity","varAppLocationMasterTemplateName","varAppLocationMasterTemplateState","varAppLocationMasterTemplateStatus","varAppLocationMasterTemplateZip",],{unique:true})
export class tblAppLocationMasterTemplate {
    ...
    @OneToMany(type=>tblAppLocationMasterTemplateAssignment, tblAppLocationMasterTemplateAssignment=>tblAppLocationMasterTemplateAssignment.intAppLocationMasterTemplateAssignmentAppLocationMasterTemplate,{ onDelete: 'CASCADE' , })
