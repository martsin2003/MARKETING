...
@Index("idx_18395_IX_tblMBFDashboard",["bMBFDashboardNotificationDeleted","bMBFDashboardNotificationViewed","dteMBFDashboardModifiedDate","dteMBFDashboardNotifiedDate","intMbfDashboardBuyer","intMBFDashboardDocumentTypeID","intMBFDashboardID","intMBFDashboardLotID","intMBFDashboardNotificationID","intMbfDashboardNotificationType","varMBFDashboardNotificationName",],{unique:true})
export class tblMBFDashboard {
    ...
    @ManyToOne(type=>tblMBFBuyer, tblMBFBuyer=>tblMBFBuyer.tblMbfDashboards,{  nullable:false,onDelete: 'CASCADE', })
    ...
    @ManyToOne(type=>tblMBFNotificationType, tblMBFNotificationType=>tblMBFNotificationType.tblMbfDashboards,{  nullable:false,onDelete: 'CASCADE', })
