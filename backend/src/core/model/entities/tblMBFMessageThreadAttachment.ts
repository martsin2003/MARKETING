...
@Index("idx_18606_IX_tblMBFMessageThreadAttachment",["intMbfMessageThreadAttachmentMbfMessageThread",])
export class tblMBFMessageThreadAttachment {
    ...
    @ManyToOne(type=>tblMBFMessageThread, tblMBFMessageThread=>tblMBFMessageThread.tblMbfMessageThreadAttachments,{  nullable:false,onDelete: 'CASCADE', })
