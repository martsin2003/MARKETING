...
@Index("idx_19823_IX_tblRTDisplayKeywordData",["dteRTDisplayKeywordDataCreatedDate","dteRTDisplayKeywordDataEndTime","intRTDisplayKeywordDataID","intRtDisplayKeywordDataRtDisplayKeyword","intRtDisplayKeywordDataRtDisplayMetric",],{unique:true})
@Index("idx_19823_IX2_tblRTDisplayKeywordData",["dteRTDisplayKeywordDataEndTime","intRTDisplayKeywordDataID","intRtDisplayKeywordDataRtDisplayKeyword","intRtDisplayKeywordDataRtDisplayMetric","intRTDisplayKeywordDataValue",])
export class tblRTDisplayKeywordData {
    ...
    @ManyToOne(type=>tblRTDisplayKeyword, tblRTDisplayKeyword=>tblRTDisplayKeyword.tblRtDisplayKeywordDatas,{  nullable:false,onDelete: 'CASCADE', })
    ...
    @ManyToOne(type=>tblRTDisplayMetric, tblRTDisplayMetric=>tblRTDisplayMetric.tblRtDisplayKeywordDatas,{  nullable:false,onDelete: 'CASCADE', })
