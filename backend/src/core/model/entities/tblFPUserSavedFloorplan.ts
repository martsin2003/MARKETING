...
export class tblFPUserSavedFloorplan {
    ...
    @ManyToOne(type=>tblFPUser, tblFPUser=>tblFPUser.tblFpUserSavedFloorplans,{  nullable:false,onDelete: 'CASCADE', })
    @JoinColumn({ name:'intFPUserSavedFloorplanFPUserID'})
    intFpUserSavedFloorplanFpUser:tblFPUser | null;


   
    @ManyToOne(type=>tblCommunity, tblCommunity=>tblCommunity.tblFpUserSavedFloorplans,{  nullable:false, })
