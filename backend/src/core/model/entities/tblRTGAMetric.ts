...
@Index("idx_20145_IX_tblRTGAMetric",["bRTGAMetricArchivedFlg","intRTGAMetricDivisor","varRTGAMetricDataStoreType","varRTGAMetricDimensions","varRTGAMetricFilters","varRTGAMetricName","varRTGAMetricSegment",],{unique:true})
export class tblRTGAMetric {
    ...
    @OneToMany(type=>tblRTGAData, tblRTGAData=>tblRTGAData.intRtgaDataMetric,{ onDelete: 'CASCADE' , })
    tblRtgaDatas:tblRTGAData[];
    

   
    @OneToMany(type=>tblRTGALabeledData, tblRTGALabeledData=>tblRTGALabeledData.intRtgaLabeledDataMetric,{ onDelete: 'CASCADE' , })
