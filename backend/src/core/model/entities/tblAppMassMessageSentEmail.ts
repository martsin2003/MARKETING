...
@Index(
  'idx_16477_IX_tblAppMassMessageSentEmail',
  [
    'intAppMassMessageSentEmailCampaignID',
    'intAppMassMessageSentEmailID',
    'intAppMassMessageSentEmailListID',
    'intAppMassMessageSentEmailMessage',
    'intAppMassMessageSentEmailSentEmailID'
  ],
  { unique: true }
)
export class tblAppMassMessageSentEmail {
  ...
  @ManyToOne(
    ...
    tblAppMassMessage => tblAppMassMessage.tblAppMassMessageSentEmails,
