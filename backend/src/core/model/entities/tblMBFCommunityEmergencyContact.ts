...
@Index("idx_18375_IX_tblMBFCommunityEmergencyContact",["intMBFCommunityEmergencyContactProjectID","intMBFCommunityEmergencyContactSubcontractorID","intMBFCommunityEmergencyContactTypeID","varMBFCommunityEmergencyContactPhone","varMBFCommunityEmergencyContactPhone2","varMBFCommunityEmergencyContactWebsite",],{unique:true})
