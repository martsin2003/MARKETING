...
@Index(
  'idx_18128_IX_tblHomeEstimateOfferAddendum',
  ['dteOfferAddendumCreatedDate', 'intHomeEstimateOffer', 'intOfferAddendum'],
  { unique: true }
)
export class tblHomeEstimateOfferAddendum {
  ...
  @ManyToOne(
    ...
    tblHomeEstimateOffer => tblHomeEstimateOffer.tblHomeEstimateOfferAddendums,
  ...
  @ManyToOne(
    type => tblOfferAddendum,
    tblOfferAddendum => tblOfferAddendum.tblHomeEstimateOfferAddendums,
    { nullable: false, onDelete: 'CASCADE' }
  )
