...
@Index("idx_19394_IX_tblRealResultsRoutePermission",["bAllowSubrouteAccessFlg","dteRealResultsRoutePermissionCreatedDate","intRealResultsRoutePermissionCreatedBy",])
export class tblRealResultsRoutePermission {
    ...
    @ManyToOne(type=>tblRealResultsRoute, tblRealResultsRoute=>tblRealResultsRoute.tblRealResultsRoutePermissions,{ primary:true, nullable:false,onDelete: 'CASCADE', })
