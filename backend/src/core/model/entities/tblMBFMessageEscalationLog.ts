...
@Index("idx_18574_IX_tblMBFMessageEscalationLog",["dteMBFMessageEscalationLogModifiedDate","intMBFMessageEscalationLogMBFCommunityProjectMessageEscalationI","intMbfMessageEscalationLogMbfMessage","varMBFMessageEscalationLogRecipients",],{unique:true})
export class tblMBFMessageEscalationLog {
    ...
    @ManyToOne(type=>tblMBFMessage, tblMBFMessage=>tblMBFMessage.tblMbfMessageEscalationLogs,{  nullable:false,onDelete: 'CASCADE', })
