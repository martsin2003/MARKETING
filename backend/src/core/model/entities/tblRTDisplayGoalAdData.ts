...
@Index('idx_19799_IX2_tblRTDisplayGoalAdData', [
  'dteRTDisplayGoalAdDataDate',
  'intRtDisplayGoalAdDataRtDisplayAd',
  'intRtDisplayGoalAdDataRtDisplayGoal',
  'intRTDisplayGoalAdDataValue'
])
@Index(
  'idx_19799_IX_tblRTDisplayGoalAdData',
  [
    'dteRTDisplayGoalAdDataDate',
    'intRTDisplayGoalAdDataID',
    'intRtDisplayGoalAdDataRtDisplayAd',
    'intRtDisplayGoalAdDataRtDisplayGoal'
  ],
  { unique: true }
...
export class tblRTDisplayGoalAdData {
  ...
  @ManyToOne(type => tblRTDisplayAd, tblRTDisplayAd => tblRTDisplayAd.tblRtDisplayGoalAdDatas, {
    nullable: false,
    onDelete: 'CASCADE'
  })
  ...
  @ManyToOne(
    ...
    tblRTDisplayGoal => tblRTDisplayGoal.tblRtDisplayGoalAdDatas,
