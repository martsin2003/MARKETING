...
@Index("idx_19760_IX2_tblRTDisplayAdGroup",["intRTDisplayAdGroupAPIID","intRTDisplayAdGroupID","intRtDisplayAdGroupRtCampaign","varRTDisplayAdGroupStatus",])
@Index("idx_19760_IX_tblRTDisplayAdGroup",["intRTDisplayAdGroupAPIID","intRtDisplayAdGroupRtCampaign","varRTDisplayAdGroupName","varRTDisplayAdGroupStatus",],{unique:true})
export class tblRTDisplayAdGroup {
    ...
    @ManyToOne(type=>tblRTCampaign, tblRTCampaign=>tblRTCampaign.tblRtDisplayAdGroups,{  nullable:false,onDelete: 'CASCADE', })
    ...
    @OneToMany(type=>tblRTDisplayAd, tblRTDisplayAd=>tblRTDisplayAd.intRtDisplayAdRtDisplayAdGroup,{ onDelete: 'CASCADE' , })
    tblRtDisplayAds:tblRTDisplayAd[];
    

   
    @OneToMany(type=>tblRTDisplayAdGroupMediaSource, tblRTDisplayAdGroupMediaSource=>tblRTDisplayAdGroupMediaSource.intRtDisplayAdGroupMediaSourceRtDisplayAdGroup,{ onDelete: 'CASCADE' , })
    tblRtDisplayAdGroupMediaSources:tblRTDisplayAdGroupMediaSource[];
    

   
    @OneToMany(type=>tblRTDisplayKeyword, tblRTDisplayKeyword=>tblRTDisplayKeyword.intRtDisplayKeywordRtDisplayAdGroup,{ onDelete: 'CASCADE' , })
