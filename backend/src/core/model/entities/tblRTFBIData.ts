...
@Index(
  'idx_20029_IX_tblRTFBIData',
  [
    'dteRTFBIDataCreatedDate',
    'dteRTFBIDataEndTime',
    'dteRTFBIDataModifiedDate',
    'intRTFBIDataID',
    'intRtfbiDataMetric',
    'intRtfbiDataRtCampaign',
    'intRTFBIDataValue'
  ],
  { unique: true }
)
@Index('idx_20029_IX3_tblRTFBIData', ['dteRTFBIDataEndTime', 'intRtfbiDataMetric'])
@Index('idx_20029_IX4_tblRTFBIData', [
  'dteRTFBIDataEndTime',
  'intRtfbiDataMetric',
  'intRTFBIDataValue'
])
...
export class tblRTFBIData {
  ...
  @ManyToOne(type => tblRTCampaign, tblRTCampaign => tblRTCampaign.tblRtfbiDatas, {
    nullable: false,
    onDelete: 'CASCADE'
  })
  ...
  @ManyToOne(type => tblRTFBIMetric, tblRTFBIMetric => tblRTFBIMetric.tblRtfbiDatas, {
    nullable: false,
    onDelete: 'CASCADE'
  })
