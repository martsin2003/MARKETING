...
@Index(
  'idx_20002_IX_tblRTFBAIData',
  ['dteRTFBAIDataEndTime', 'intRtfbaiDataMetric', 'intRtfbaiDataRtfbaiAd'],
  { unique: true }
)
export class tblRTFBAIData {
  ...
  @ManyToOne(type => tblRTFBAIAd, tblRTFBAIAd => tblRTFBAIAd.tblRtfbaiDatas, {
    nullable: false,
    onDelete: 'CASCADE'
  })
  ...
  @ManyToOne(type => tblRTFBAIMetric, tblRTFBAIMetric => tblRTFBAIMetric.tblRtfbaiDatas, {
    nullable: false,
    onDelete: 'CASCADE'
  })
