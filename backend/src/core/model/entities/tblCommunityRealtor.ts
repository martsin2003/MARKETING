...
@Index('idx_16952_IX_A1_tblCommunityRealtor', [
  'intCommunityRealtorCommunityID',
  'intCommunityRealtorRealtorID'
])
export class tblCommunityRealtor {
  ...
  @OneToMany(
    type => tblCommunityRealtorReturnTrack,
    tblCommunityRealtorReturnTrack =>
      tblCommunityRealtorReturnTrack.intCommunityRealtorReturnTrackCommunityRealtor,
    { onDelete: 'CASCADE' }
  )
