...
@Index(
  'idx_18551_IX_tblMBFLotToDoAssociation',
  [
    'dteMBFLotToDoAssociationModifiedDate',
    'intMBFLotToDoAssociationDocumentCategoryID',
    'intMBFLotToDoAssociationID',
    'intMBFLotToDoAssociationToDoAssociationID',
    'intMbfLotToDoAssociationToDo',
    'intMBFLotToDoAssociationToDoTypeID'
  ],
  { unique: true }
)
export class tblMBFLotToDoAssociation {
  ...
  @ManyToOne(type => tblMBFLotToDo, tblMBFLotToDo => tblMBFLotToDo.tblMbfLotToDoAssociations, {
    nullable: false,
    onDelete: 'CASCADE'
  })
