...
@Index('idx_17648_IX_tblFPCommunityModelElevationOptionDisplayAsStandar', [
  'bFPCommunityModelElevationOptionDisplayAsStandardDeletedFlg',
  'dteFPCommunityModelElevationOptionDisplayAsStandardCreatedDate',
  'dteFPCommunityModelElevationOptionDisplayAsStandardModifiedDate',
  'intFpCommunityModelElevationOptionDisplayAsStandardFpCommunityM',
  'intFpCommunityModelElevationOptionDisplayAsStandardFpFloorOptio',
  'intFPCommunityModelElevationOptionDisplayAsStandardID',
...
export class tblFPCommunityModelElevationOptionDisplayAsStandard {
  ...
  @ManyToOne(
    ...
    tblFPCommunityModelElevation =>
      tblFPCommunityModelElevation.tblFpCommunityModelElevationOptionDisplayAsStandards,
  ...
  @ManyToOne(
    ...
    tblFPFloorOption => tblFPFloorOption.tblFpCommunityModelElevationOptionDisplayAsStandards,
    { nullable: false }
  )
