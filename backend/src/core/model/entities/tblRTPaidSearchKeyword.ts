...
@Index("idx_20364_IX_tblRTPaidSearchKeyword",["intRTPaidSearchKeywordAPIID","intRTPaidSearchKeywordID","intRtPaidSearchKeywordRtPaidSearchAdGroup","varRTPaidSearchKeyword","varRTPaidSearchKeywordMatchType","varRTPaidSearchKeywordStatus",],{unique:true})
export class tblRTPaidSearchKeyword {
    ...
    @ManyToOne(type=>tblRTPaidSearchAdGroup, tblRTPaidSearchAdGroup=>tblRTPaidSearchAdGroup.tblRtPaidSearchKeywords,{  nullable:false,onDelete: 'CASCADE', })
    ...
    @OneToMany(type=>tblRTPaidSearchGoalKeywordData, tblRTPaidSearchGoalKeywordData=>tblRTPaidSearchGoalKeywordData.intRtPaidSearchGoalKeywordDataRtPaidSearchKeyword,{ onDelete: 'CASCADE' , })
    tblRtPaidSearchGoalKeywordDatas:tblRTPaidSearchGoalKeywordData[];
    

   
    @OneToMany(type=>tblRTPaidSearchGoalKeywordNonAdwordsData, tblRTPaidSearchGoalKeywordNonAdwordsData=>tblRTPaidSearchGoalKeywordNonAdwordsData.intRtPaidSearchGoalKeywordNonAdwordsDataRtPaidSearchKeyword,{ onDelete: 'CASCADE' , })
    tblRtPaidSearchGoalKeywordNonAdwordsDatas:tblRTPaidSearchGoalKeywordNonAdwordsData[];
    

   
    @OneToMany(type=>tblRTPaidSearchKeywordData, tblRTPaidSearchKeywordData=>tblRTPaidSearchKeywordData.intRtPaidSearchKeywordDataRtPaidSearchKeyword,{ onDelete: 'CASCADE' , })
