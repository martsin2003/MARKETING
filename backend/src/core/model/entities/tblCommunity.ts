...
export class tblCommunity {
  ...
  @OneToMany(type => tblBDXHotHome, tblBDXHotHome => tblBDXHotHome.intBdxHotHomeCommunity, {
    onDelete: 'SET NULL'
  })
  tblBdxHotHomes: tblBDXHotHome[];

  @OneToMany(
    type => tblCommunityARHeaderGraphic,
    tblCommunityARHeaderGraphic => tblCommunityARHeaderGraphic.intCommunityArHeaderGraphicCommunity,
    { onDelete: 'CASCADE' }
  )
  tblCommunityArHeaderGraphics: tblCommunityARHeaderGraphic[];

  @OneToMany(
    type => tblCommunityBrochure,
    tblCommunityBrochure => tblCommunityBrochure.intCommunityBrochureCommunity,
    { onDelete: 'CASCADE' }
  )
  tblCommunityBrochures: tblCommunityBrochure[];

  @OneToMany(
    type => tblCommunityEmailMarketingAssets,
    tblCommunityEmailMarketingAssets =>
      tblCommunityEmailMarketingAssets.intCommunityEmailMarketingAssetsCommunity,
    { onDelete: 'CASCADE' }
  )
  tblCommunityEmailMarketingAssetss: tblCommunityEmailMarketingAssets[];

  @OneToMany(
    type => tblCommunityEvent,
    tblCommunityEvent => tblCommunityEvent.intCommunityEventCommunity,
    { onDelete: 'CASCADE' }
  )
  tblCommunityEvents: tblCommunityEvent[];

  @OneToMany(
    type => tblCommunityFlag,
    tblCommunityFlag => tblCommunityFlag.intCommunityFlagCommunity,
    { onDelete: 'SET NULL' }
  )
  tblCommunityFlags: tblCommunityFlag[];

  @OneToMany(
    type => tblCommunityMicrositeSliderGallery,
    tblCommunityMicrositeSliderGallery =>
      tblCommunityMicrositeSliderGallery.intCommunityMicrositeSliderGalleryCommunity,
    { onDelete: 'CASCADE' }
  )
  tblCommunityMicrositeSliderGallerys: tblCommunityMicrositeSliderGallery[];

  @OneToMany(
    type => tblCommunityOfferAddendum,
    tblCommunityOfferAddendum => tblCommunityOfferAddendum.intCommunityOfferAddendumCommunity
  )
  tblCommunityOfferAddendums: tblCommunityOfferAddendum[];

  @OneToMany(
    type => tblCommunityProject,
    tblCommunityProject => tblCommunityProject.intCommunityProjectCommunity,
    { onDelete: 'CASCADE' }
  )
  tblCommunityProjects: tblCommunityProject[];

  @OneToMany(
    type => tblCommunityPromotion,
    tblCommunityPromotion => tblCommunityPromotion.intCommunityPromotionCommunity,
    { onDelete: 'CASCADE' }
  )
  tblCommunityPromotions: tblCommunityPromotion[];

  @OneToMany(
    type => tblCommunitySitePlanHomeType,
    tblCommunitySitePlanHomeType =>
      tblCommunitySitePlanHomeType.intCommunitySitePlanHomeTypeCommunity,
    { onDelete: 'CASCADE' }
  )
  tblCommunitySitePlanHomeTypes: tblCommunitySitePlanHomeType[];

  @OneToMany(
    type => tblCommunitySiteplanGallery,
    tblCommunitySiteplanGallery => tblCommunitySiteplanGallery.intCommunitySiteplanGalleryCommunity,
    { onDelete: 'CASCADE' }
  )
  tblCommunitySiteplanGallerys: tblCommunitySiteplanGallery[];

  @OneToMany(
    type => tblEDMonthlyDashboard,
    tblEDMonthlyDashboard => tblEDMonthlyDashboard.intEdMonthlyDashboardCommunity,
    { onDelete: 'CASCADE' }
  )
  tblEdMonthlyDashboards: tblEDMonthlyDashboard[];

  @OneToMany(
    type => tblEDYearlyDashboard,
    tblEDYearlyDashboard => tblEDYearlyDashboard.intEdYearlyDashboardCommunity,
    { onDelete: 'CASCADE' }
  )
  ...
  @OneToMany(
    ...
    tblFPCommunityModelElevation =>
      tblFPCommunityModelElevation.intFpCommunityModelElevationCommunity,
    { onDelete: 'CASCADE' }
  )
  ...
  @OneToMany(
    ...
    tblFPCommunityModelGroupGallery =>
      tblFPCommunityModelGroupGallery.intFpCommunityModelGroupGalleryCommunity
  )
  ...
  @OneToMany(
    ...
    tblFPCommunityModelOptionGallery =>
      tblFPCommunityModelOptionGallery.intFpCommunityModelOptionGalleryCommunity
  )
  tblFpCommunityModelOptionGallerys: tblFPCommunityModelOptionGallery[];

  @OneToMany(
    type => tblFPUserSavedFloorplan,
    tblFPUserSavedFloorplan => tblFPUserSavedFloorplan.intFpUserSavedFloorplanCommunity
  )
  tblFpUserSavedFloorplans: tblFPUserSavedFloorplan[];

  @OneToMany(type => tblHomeEstimate, tblHomeEstimate => tblHomeEstimate.intHomeEstimateCommunity, {
    onDelete: 'SET NULL'
  })
  tblHomeEstimates: tblHomeEstimate[];

  @OneToMany(
    type => tblMBFCommunityAccess,
    tblMBFCommunityAccess => tblMBFCommunityAccess.intMbfCommunityAccessCommunity,
    { onDelete: 'CASCADE' }
  )
  tblMbfCommunityAccesss: tblMBFCommunityAccess[];

  @OneToMany(
    type => tblMoveInBrochure,
    tblMoveInBrochure => tblMoveInBrochure.intMoveInBrochureModel,
    { onDelete: 'CASCADE' }
  )
  tblMoveInBrochures: tblMoveInBrochure[];

  @OneToMany(type => tblPlanBrochure, tblPlanBrochure => tblPlanBrochure.intPlanBrochureModel, {
    onDelete: 'CASCADE'
  })
  tblPlanBrochures: tblPlanBrochure[];

  @OneToMany(type => tblWMCommunity, tblWMCommunity => tblWMCommunity.intWmCommunityCommunity, {
    onDelete: 'CASCADE'
  })
