...
@Index(
  'idx_17322_IX_tblContractPlanProject',
  [
    'dteContractPlanProjectCreatedDate',
    'dteContractPlanProjectModifiedDate',
    'intContractPlanProjectCommunityProject',
    'varContractPlanProjectPlanCode',
    'varContractPlanProjectProjectCode'
  ],
  { unique: true }
)
@Index(
  'idx_17322_IX_tblContractPlanProject2',
  [
    'intContractPlanProjectCommunityProject',
    'varContractPlanProjectPlanCode',
    'varContractPlanProjectProjectCode'
...
export class tblContractPlanProject {
  ...
  @ManyToOne(
    ...
    tblCommunityProject => tblCommunityProject.tblContractPlanProjects,
  ...
  @OneToMany(
    ...
    tblContractPlanContractPlanProjectXRef =>
      tblContractPlanContractPlanProjectXRef.intContractPlanContractPlanProjectXRefContractPlanProject,
    { onDelete: 'CASCADE' }
  )
  tblContractPlanContractPlanProjectXRefs: tblContractPlanContractPlanProjectXRef[];

  @OneToMany(
    type => tblContractPlanProjectHEOption,
    tblContractPlanProjectHEOption =>
      tblContractPlanProjectHEOption.intContractPlanProjectHeOptionContractPlanProject,
    { onDelete: 'CASCADE' }
  )
