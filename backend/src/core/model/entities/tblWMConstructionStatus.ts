...
@Index("idx_20824_IX_tblWMConstructionStatus",["bWMConstructionStatusUseForDropdown","bWMConstructionStatusUseForLegend","intWMConstructionStatusOrder","varWMConstructionStatusName",],{unique:true})
