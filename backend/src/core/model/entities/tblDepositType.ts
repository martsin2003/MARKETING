...
export class tblDepositType {
    ...
    @OneToMany(type=>tblHomeEstimateFinancePlanDeposit, tblHomeEstimateFinancePlanDeposit=>tblHomeEstimateFinancePlanDeposit.intDepositDepositType,{ onDelete: 'SET NULL' , })
