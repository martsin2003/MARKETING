...
@Index("idx_16895_IX_tblCommunityMicrositeSliderGallery",["bCommunityMicrositeSliderGalleryDefault","dteCommunityMicrositeSliderGalleryModifiedDate","intCommunityMicrositeSliderGalleryCommunity","intCommunityMicrositeSliderGalleryID","intCommunityMicrositeSliderGalleryNavOrder","varCommunityMicrositeSliderGalleryImageFile",],{unique:true})
export class tblCommunityMicrositeSliderGallery {
    ...
    @ManyToOne(type=>tblCommunity, tblCommunity=>tblCommunity.tblCommunityMicrositeSliderGallerys,{  nullable:false,onDelete: 'CASCADE', })
