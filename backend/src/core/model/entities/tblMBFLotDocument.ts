...
@Index(
  'idx_18491_IX_tblMBFLotDocument',
  [
    'bMBFLotDocumentIsHomeSpecific',
    'dteMBFLotDocumentModifiedDate',
    'intMbfLotDocumentCategory',
    'intMBFLotDocumentID',
    'intMbfLotDocumentLot',
    'intMBFLotDocumentPhaseID',
    'varMBFLotDocumentName',
    'varMBFLotDocumentStatus'
  ],
  { unique: true }
)
export class tblMBFLotDocument {
  ...
  @ManyToOne(type => tblMBFLot, tblMBFLot => tblMBFLot.tblMbfLotDocuments, {
    nullable: false,
    onDelete: 'CASCADE'
  })
  ...
  @ManyToOne(type => tblMBFCategory, tblMBFCategory => tblMBFCategory.tblMbfLotDocuments, {
    nullable: false,
    onDelete: 'CASCADE'
  })
