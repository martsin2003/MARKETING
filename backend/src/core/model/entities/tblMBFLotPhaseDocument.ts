...
@Index(
  'idx_18534_IX_tblMBFLotPhaseDocument',
  ['intMbfLotPhaseDocumentDocument', 'intMBFLotPhaseDocumentID', 'intMbfLotPhaseDocumentLot'],
  { unique: true }
)
export class tblMBFLotPhaseDocument {
  ...
  @ManyToOne(type => tblMBFLot, tblMBFLot => tblMBFLot.tblMbfLotPhaseDocuments, {
    nullable: false,
    onDelete: 'CASCADE'
  })
  ...
  @ManyToOne(
    type => tblMBFPhaseDocument,
    tblMBFPhaseDocument => tblMBFPhaseDocument.tblMbfLotPhaseDocuments,
