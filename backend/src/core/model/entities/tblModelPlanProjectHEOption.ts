...
@Index("idx_18913_IX_tblModelPlanProjectHEOption",["curModelPlanProjectHEOptionHEOptionUnitPrice","intModelPlanProjectHeOptionHeOption","intModelPlanProjectHeOptionModelPlanProject","varModelPlanProjectHEOptionPlanProjectOptionHash",])
export class tblModelPlanProjectHEOption {
    ...
    @ManyToOne(type=>tblModelPlanProject, tblModelPlanProject=>tblModelPlanProject.tblModelPlanProjectHeOptions,{  })
