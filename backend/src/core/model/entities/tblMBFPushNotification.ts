...
@Index("idx_18695_IX_tblMBFPushNotification",["dteMBFPushNotificationNotifiedDate","intMBFPushNotificationID","intMbfPushNotificationMbfCategory","intMbfPushNotificationMbfDevice","intMbfPushNotificationMbfNotificationType","intMBFPushNotificationNotificationID","varMBFPushNotificationContent","varMBFPushNotificationMessageCode",],{unique:true})
export class tblMBFPushNotification {
    ...
    @ManyToOne(type=>tblMBFDevice, tblMBFDevice=>tblMBFDevice.tblMbfPushNotifications,{  nullable:false,onDelete: 'CASCADE', })
    @JoinColumn({ name:'intMBFPushNotificationMBFDeviceID'})
    intMbfPushNotificationMbfDevice:tblMBFDevice | null;


   
    @ManyToOne(type=>tblMBFNotificationType, tblMBFNotificationType=>tblMBFNotificationType.tblMbfPushNotifications,{  nullable:false,onDelete: 'CASCADE', })
    ...
    @ManyToOne(type=>tblMBFCategory, tblMBFCategory=>tblMBFCategory.tblMbfPushNotifications,{  nullable:false,onDelete: 'CASCADE', })
