...
export class tblChangeOrderSnapshot {
    ...
    @ManyToOne(type=>tblChangeOrder, tblChangeOrder=>tblChangeOrder.tblChangeOrderSnapshots,{  nullable:false, })
    ...
    @OneToMany(type=>tblChangeOrderOptionSnapshot, tblChangeOrderOptionSnapshot=>tblChangeOrderOptionSnapshot.intChangeOrderOptionSnapshotChangeOrderSnapshot,{ onDelete: 'CASCADE' , })
