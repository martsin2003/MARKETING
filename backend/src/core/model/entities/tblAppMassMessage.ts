...
@Index("idx_16459_IX_tblAppMassMessage",["bAppMassMessageIsScheduledFlg","bAppMassMessageSendEmailFlg","dteAppMassMessageScheduledSendDateTime","intAppMassMessageID","intAppMassMessageTemplate","varAppMassMessageNonce","varAppMassMessageStatus","varAppMassMessageSubject",],{unique:true})
export class tblAppMassMessage {
    ...
    @ManyToOne(type=>tblAppMassMessageTemplate, tblAppMassMessageTemplate=>tblAppMassMessageTemplate.tblAppMassMessages,{ onDelete: 'SET NULL', })
    ...
    @OneToMany(type=>tblAppMassMessageSent, tblAppMassMessageSent=>tblAppMassMessageSent.intAppMassMessageSentMessage,{ onDelete: 'CASCADE' , })
    tblAppMassMessageSents:tblAppMassMessageSent[];
    

   
    @OneToMany(type=>tblAppMassMessageSentEmail, tblAppMassMessageSentEmail=>tblAppMassMessageSentEmail.intAppMassMessageSentEmailMessage,{ onDelete: 'CASCADE' , })
