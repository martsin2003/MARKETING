...
@Index("idx_20276_IX_tblRTPaidSearchAd",["intRTPaidSearchAdAPIID","intRtPaidSearchAdRtPaidSearchAdGroup","varRTPaidSearchAdName","varRTPaidSearchAdStatus","varRTPaidSearchAdType",],{unique:true})
...
export class tblRTPaidSearchAd {
    ...
    @ManyToOne(type=>tblRTPaidSearchAdGroup, tblRTPaidSearchAdGroup=>tblRTPaidSearchAdGroup.tblRtPaidSearchAds,{  nullable:false,onDelete: 'CASCADE', })
    ...
    @OneToMany(type=>tblRTPaidSearchAdData, tblRTPaidSearchAdData=>tblRTPaidSearchAdData.intRtPaidSearchAdDataRtPaidSearchAd,{ onDelete: 'CASCADE' , })
    tblRtPaidSearchAdDatas:tblRTPaidSearchAdData[];
    

   
    @OneToMany(type=>tblRTPaidSearchGAGoalAdData, tblRTPaidSearchGAGoalAdData=>tblRTPaidSearchGAGoalAdData.intRtPaidSearchGaGoalAdDataRtPaidSearchAd,{ onDelete: 'CASCADE' , })
    tblRtPaidSearchGaGoalAdDatas:tblRTPaidSearchGAGoalAdData[];
    

   
    @OneToMany(type=>tblRTPaidSearchGoalAdData, tblRTPaidSearchGoalAdData=>tblRTPaidSearchGoalAdData.intRtPaidSearchGoalAdDataRtPaidSearchAd,{ onDelete: 'CASCADE' , })
    tblRtPaidSearchGoalAdDatas:tblRTPaidSearchGoalAdData[];
    

   
    @OneToMany(type=>tblRTPaidSearchLabeledAdData, tblRTPaidSearchLabeledAdData=>tblRTPaidSearchLabeledAdData.intRtPaidSearchLabeledAdDataRtPaidSearchAd,{ onDelete: 'CASCADE' , })
