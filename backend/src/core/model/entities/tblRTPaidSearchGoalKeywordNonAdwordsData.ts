...
@Index('idx_20358_IX2_tblRTPaidSearchGoalKeywordNonAdwordsData', [
  'dteRTPaidSearchGoalKeywordNonAdwordsDataDate',
  'intRTPaidSearchGoalKeywordNonAdwordsDataValue'
])
@Index(
  'idx_20358_IX_tblRTPaidSearchGoalKeywordNonAdwordsData',
  [
    'dteRTPaidSearchGoalKeywordNonAdwordsDataDate',
    'intRtPaidSearchGoalKeywordNonAdwordsDataRtgaGoal',
    'intRtPaidSearchGoalKeywordNonAdwordsDataRtPaidSearchKeyword',
    'intRTPaidSearchGoalKeywordNonAdwordsDataValue'
  ],
  { unique: true }
)
export class tblRTPaidSearchGoalKeywordNonAdwordsData {
  ...
  @ManyToOne(
    type => tblRTPaidSearchKeyword,
    tblRTPaidSearchKeyword => tblRTPaidSearchKeyword.tblRtPaidSearchGoalKeywordNonAdwordsDatas,
  ...
  @ManyToOne(
    type => tblRTGAGoal,
    tblRTGAGoal => tblRTGAGoal.tblRtPaidSearchGoalKeywordNonAdwordsDatas,
    { nullable: false }
  )
