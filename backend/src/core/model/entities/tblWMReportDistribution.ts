...
@Index(
  'idx_20902_IX_tblWMReportDistribution',
  [
    'dteWMReportDistributionCreatedDate',
    'intWmReportDistributionWmDistributionRecipient',
    'intWmReportDistributionWmReport'
  ],
  { unique: true }
)
export class tblWMReportDistribution {
  @ManyToOne(type => tblWMReport, tblWMReport => tblWMReport.tblWmReportDistributions, {
    primary: true,
    nullable: false,
    onDelete: 'CASCADE'
  })
  ...
  @ManyToOne(
    type => tblWMDistributionRecipient,
    tblWMDistributionRecipient => tblWMDistributionRecipient.tblWmReportDistributions,
