...
@Index(
  'idx_17533_IX_tblFinancePlan',
  [
    'bFinancePlanMortgageInsLenderPaid',
    'curFinancePlanARMAdjustmentsPct',
    'curFinancePlanARMCapRatePct',
    'curFinancePlanARMIndexRatePct',
    'curFinancePlanFundingFeePct',
    'curFinancePlanInterestRatePct',
    'curFinancePlanMaxLoanAmt',
    'curFinancePlanMinDownPmntPct',
    'curFinancePlanMortgageInsRatePct',
    'intFinancePlanFinancePlanLender',
    'intFinancePlanFinancePlanLoanType',
    'intFinancePlanLoanTerm',
    'intFinancePlanPrepaidInsuranceDays',
    'intFinancePlanPrepaidInterestDays',
    'intFinancePlanPrepaidTaxesDays',
    'varFinancePlanName'
  ],
  { unique: true }
)
export class tblFinancePlan {
  ...
  @ManyToOne(
    type => tblFinancePlanLoanType,
    tblFinancePlanLoanType => tblFinancePlanLoanType.tblFinancePlans,
    { onDelete: 'SET NULL' }
  )
  @JoinColumn({ name: 'intFinancePlanFinancePlanLoanTypeID' })
  intFinancePlanFinancePlanLoanType: tblFinancePlanLoanType | null;

  @ManyToOne(type => tblPreferredLender, tblPreferredLender => tblPreferredLender.tblFinancePlans, {
    onDelete: 'SET NULL'
  })
  ...
  @OneToMany(
    ...
    tblHomeEstimateFinancePlan => tblHomeEstimateFinancePlan.intFinancePlan,
    { onDelete: 'SET NULL' }
  )
  ...
  @OneToMany(
    ...
    tblHomeEstimateFinancePlanXRef => tblHomeEstimateFinancePlanXRef.intFinancePlan,
    { onDelete: 'SET NULL' }
  )
