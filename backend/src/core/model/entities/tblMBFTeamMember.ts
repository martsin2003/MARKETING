...
@Index("idx_18704_IX_tblMBFTeamMember",["bMBFTeamMemberIsCompany","bMBFTeamMemberSMSForMobile","dteMBFTeamMemberModifiedDate","intMBFTeamMemberID","intMbfTeamMemberType","varMBFTeamMemberCompanyName","varMBFTeamMemberEmailAddress","varMBFTeamMemberFirstName","varMBFTeamMemberLastName","varMBFTeamMemberStatus","varMBFTeamMemberTitle",],{unique:true})
export class tblMBFTeamMember {
    ...
    @ManyToOne(type=>tblMBFTeamMemberType, tblMBFTeamMemberType=>tblMBFTeamMemberType.tblMbfTeamMembers,{  nullable:false,onDelete: 'CASCADE', })
    ...
    @OneToMany(type=>tblMBFTeamMemberCommunityProject, tblMBFTeamMemberCommunityProject=>tblMBFTeamMemberCommunityProject.intMbfTeamMemberCommunityProjectTeamMember,{ onDelete: 'CASCADE' , })
    tblMbfTeamMemberCommunityProjects:tblMBFTeamMemberCommunityProject[];
    

   
    @OneToMany(type=>tblMBFTeamMemberLot, tblMBFTeamMemberLot=>tblMBFTeamMemberLot.intMbfTeamMemberLotTeamMember,{ onDelete: 'CASCADE' , })
    tblMbfTeamMemberLots:tblMBFTeamMemberLot[];
    

   
    @OneToMany(type=>tblMBFTeamMemberSalesReportUser, tblMBFTeamMemberSalesReportUser=>tblMBFTeamMemberSalesReportUser.intMbfTeamMemberSalesReportUserMbfTeamMember)
