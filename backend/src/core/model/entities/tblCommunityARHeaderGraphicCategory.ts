...
export class tblCommunityARHeaderGraphicCategory {
  ...
  @ManyToOne(
    type => tblCommunityARHeaderGraphicARType,
    tblCommunityARHeaderGraphicARType =>
      tblCommunityARHeaderGraphicARType.tblCommunityArHeaderGraphicCategorys,
  ...
  @OneToMany(
    ...
    tblCommunityARHeaderGraphic => tblCommunityARHeaderGraphic.varCommunityArHeaderGraphicAr,
    { onDelete: 'CASCADE' }
  )
  ...
  @OneToMany(
    ...
    tblContactAutomatedEmail => tblContactAutomatedEmail.varContactAutomatedEmailName,
    { onDelete: 'CASCADE' }
  )
