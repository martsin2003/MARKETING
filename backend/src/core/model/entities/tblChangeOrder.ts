...
export class tblChangeOrder {
    ...
    @OneToMany(type=>tblChangeOrderDetail, tblChangeOrderDetail=>tblChangeOrderDetail.intChangeOrderDetailChangeOrder,{ onDelete: 'CASCADE' , })
    tblChangeOrderDetails:tblChangeOrderDetail[];
    

   
    @OneToMany(type=>tblChangeOrderSnapshot, tblChangeOrderSnapshot=>tblChangeOrderSnapshot.intChangeOrderSnapshotChangeOrder)
