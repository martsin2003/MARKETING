...
export class tblHomeEstimateOffer {
    ...
    @ManyToOne(type=>tblHomeEstimateFinancePlanXRef, tblHomeEstimateFinancePlanXRef=>tblHomeEstimateFinancePlanXRef.tblHomeEstimateOffers,{ onDelete: 'CASCADE', })
    ...
    @OneToMany(type=>tblHomeEstimateOfferAddendum, tblHomeEstimateOfferAddendum=>tblHomeEstimateOfferAddendum.intHomeEstimateOffer,{ onDelete: 'CASCADE' , })
    tblHomeEstimateOfferAddendums:tblHomeEstimateOfferAddendum[];
    

   
    @OneToMany(type=>tblHomeEstimateOfferChangeOrderXRef, tblHomeEstimateOfferChangeOrderXRef=>tblHomeEstimateOfferChangeOrderXRef.intHomeEstimateOffer,{ onDelete: 'CASCADE' , })
    tblHomeEstimateOfferChangeOrderXRefs:tblHomeEstimateOfferChangeOrderXRef[];
    

   
    @OneToMany(type=>tblHomeEstimateOfferContract, tblHomeEstimateOfferContract=>tblHomeEstimateOfferContract.intHomeEstimateOfferContractHomeEstimateOffer,{ onDelete: 'CASCADE' , })
