...
@Index(
  'idx_17951_IDX_tblFPUser',
  [
    'bFPUserDeletedFlg',
    'dteFPUserLastLoginDate',
    'dteFPUserModifiedDate',
    'dteFPUserRegisteredDate',
    'varFPUserEmail',
    'varFPUserFirstName',
    'varFPUserLastName',
    'varFPUserPassword',
...
export class tblFPUser {
  ...
  @OneToMany(
    type => tblFPUserEmployee,
    tblFPUserEmployee => tblFPUserEmployee.intFpUserEmployeeFpUser,
    { onDelete: 'CASCADE' }
  )
  ...
  @OneToMany(
    ...
    tblFPUserSavedFloorplan => tblFPUserSavedFloorplan.intFpUserSavedFloorplanFpUser,
    { onDelete: 'CASCADE' }
  )
