...
@Index("idx_17670_IX_tblFPCommunityModelElevationOptionRemove",["bFPCommunityModelElevationOptionRemoveDeletedFlg","intFpCommunityModelElevationOptionRemoveFpCommunityModelElevati","intFpCommunityModelElevationOptionRemoveFpFloorOption",])
export class tblFPCommunityModelElevationOptionRemove {
    ...
    @ManyToOne(type=>tblFPCommunityModelElevation, tblFPCommunityModelElevation=>tblFPCommunityModelElevation.tblFpCommunityModelElevationOptionRemoves,{  nullable:false,onDelete: 'CASCADE', })
    ...
    @ManyToOne(type=>tblFPFloorOption, tblFPFloorOption=>tblFPFloorOption.tblFpCommunityModelElevationOptionRemoves,{  nullable:false, })
