...
@Index("idx_17192_IX_tblContactAutomatedEmailCancelled",["dteContactAutomatedEmailCancelledCancelledDate","intContactAutomatedEmailCancelledContactAutomatedEmail","intContactAutomatedEmailCancelledContact","intContactAutomatedEmailCancelledID",],{unique:true})
export class tblContactAutomatedEmailCancelled {
    ...
    @ManyToOne(type=>tblContact, tblContact=>tblContact.tblContactAutomatedEmailCancelleds,{  nullable:false,onDelete: 'CASCADE', })
    @JoinColumn({ name:'intContactAutomatedEmailCancelledContactID'})
    intContactAutomatedEmailCancelledContact:tblContact | null;


   
    @ManyToOne(type=>tblContactAutomatedEmail, tblContactAutomatedEmail=>tblContactAutomatedEmail.tblContactAutomatedEmailCancelleds,{  nullable:false,onDelete: 'CASCADE', })
