...
export class tblFPCommunityModelGroupGallery {
    ...
    @ManyToOne(type=>tblFPFloorGroup, tblFPFloorGroup=>tblFPFloorGroup.tblFpCommunityModelGroupGallerys,{  nullable:false, })
    ...
    @ManyToOne(type=>tblCommunity, tblCommunity=>tblCommunity.tblFpCommunityModelGroupGallerys,{  nullable:false, })
    @JoinColumn({ name:'intFPCommunityModelGroupGalleryCommunityID'})
    intFpCommunityModelGroupGalleryCommunity:tblCommunity | null;


   
    @ManyToOne(type=>tblModel, tblModel=>tblModel.tblFpCommunityModelGroupGallerys,{  nullable:false, })
