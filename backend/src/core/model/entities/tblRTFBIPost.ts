...
@Index("idx_20082_IX_tblRTFBIPost",["dteRTFBIPostPublishedDate","intRTFBIPostFBPostID","intRtfbiPostRtCampaign","varRTFBIPostTitle","varRTFBIPostType",],{unique:true})
export class tblRTFBIPost {
    ...
    @ManyToOne(type=>tblRTCampaign, tblRTCampaign=>tblRTCampaign.tblRtfbiPosts,{  nullable:false,onDelete: 'CASCADE', })
