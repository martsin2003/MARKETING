...
@Index(
  'idx_18406_IX_tblMBFDevice',
  ['intMBFDeviceID', 'intMBFDeviceType', 'varMBFDeviceHWID', 'varMBFDevicePushToken'],
  { unique: true }
)
export class tblMBFDevice {
  ...
  @OneToMany(
    ...
    tblMBFBuyerDevice => tblMBFBuyerDevice.intMbfBuyerDeviceMbfDevice,
    { onDelete: 'CASCADE' }
  )
  ...
  @OneToMany(
    ...
    tblMBFPushNotification => tblMBFPushNotification.intMbfPushNotificationMbfDevice,
    { onDelete: 'CASCADE' }
  )
