...
export class tblRTDisplayAdGroupMediaSource {
    ...
    @ManyToOne(type=>tblRTDisplayAdGroup, tblRTDisplayAdGroup=>tblRTDisplayAdGroup.tblRtDisplayAdGroupMediaSources,{ primary:true, nullable:false,onDelete: 'CASCADE', })
    ...
    @ManyToOne(type=>tblRTMediaSource, tblRTMediaSource=>tblRTMediaSource.tblRtDisplayAdGroupMediaSources,{ primary:true, nullable:false,onDelete: 'CASCADE', })
