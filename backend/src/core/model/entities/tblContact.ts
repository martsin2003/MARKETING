...
@Index("idx_17079_IX_tblContact_forGeocoding",["bContactAddressUpdated","bContactTransferred","dteContactEntered","fltLatitude","fltLongitude","intContactCommunityID","intContactID","varContactAddress1","varContactCity","varContactFirstName","varContactLastName","varContactState","varContactZipCode",])
@Index("idx_17079_IX_A4_tblContact",["bContactBeBack1","bContactBeBack10","bContactBeBack2","bContactBeBack3","bContactBeBack4","bContactBeBack5","bContactBeBack6","bContactBeBack7","bContactBeBack8","bContactBeBack9","dteContactBeBackDate1","dteContactBeBackDate10","dteContactBeBackDate2","dteContactBeBackDate3","dteContactBeBackDate4","dteContactBeBackDate5","dteContactBeBackDate6","dteContactBeBackDate7","dteContactBeBackDate8","dteContactBeBackDate9","intContactCommunityID","intContactCommunityProjectID","intContactID","varContactEmailPrimary",])
@Index("idx_17079_IX_A5_tblContact",["bContactBeBack1","bContactBeBack10","bContactBeBack2","bContactBeBack3","bContactBeBack4","bContactBeBack5","bContactBeBack6","bContactBeBack7","bContactBeBack8","bContactBeBack9","dteContactBeBackDate1","dteContactBeBackDate10","dteContactBeBackDate2","dteContactBeBackDate3","dteContactBeBackDate4","dteContactBeBackDate5","dteContactBeBackDate6","dteContactBeBackDate7","dteContactBeBackDate8","dteContactBeBackDate9","intContactCommunityID","intContactCommunityProjectID","intContactID","varContactEmailPrimary",])
@Index("idx_17079_IX_tblContact_dteContactModifiedDate",["bContactBuildYourHomeSent","bContactDepartureHomeConsultationSent","bContactEmailOptOut","bContactHomesiteDemonstrationSent","bContactHomesiteReservationSent","bContactLenderConsultationSent","bContactModelDemonstrationSent","bContactMyEmmaMemberOptIn","bContactOwnershipEstimateSent","dteContactModifiedDate","intContactCommunityID","intContactID","varContactBuildYourHome","varContactDepartureHomeConsultation","varContactEmailPrimary","varContactFirstName","varContactHomesiteDemonstration","varContactHomesiteReservation","varContactLastName","varContactLenderConsultation","varContactModelDemonstration","varContactMyEmmaMemberID","varContactMyEmmaMemberStatus","varContactOwnershipEstimate",])
@Index("idx_17079_IX_tblContact_MyEmma",["bContactEmailOptOut","intContactCategoryID","intContactContactStatusID","intContactContactTypeID","intContactID","varContactEmailPrimary","varContactMyEmmaMemberID","varContactMyEmmaMemberStatus",])
@Index("idx_17079_IX_A1_tblContact",["bContactTopProspect","bContactTransferred","bContactWalkIn","dteContactVisited","intContactCategoryID","intContactCommunityID","intContactCommunityOfInterestID","intContactContactStatusID","intContactContactTypeID","intContactID","varContactEmailPrimary","varContactFirstName","varContactLastName","varContactLevel","varContactMI","varContactMobilePhone","varContactSurveyHearAbout",])
@Index("idx_17079_IX_tblContact_Reporting2",["bContactTransferred","dteContactVisited","intContactCommunityID","intContactCommunityID_Org","intContactContactTypeID",])
@Index("idx_17079_IX_tblContact_TypeStatus",["bContactWalkIn","dteContactVisited","dteContactWalkInDate","intContactCategoryID","intContactContactStatusID","intContactContactTypeID","intContactID",])
@Index("idx_17079_IX_tblContact_BeBacks",["dteContactBeBackDate1","dteContactBeBackDate10","dteContactBeBackDate2","dteContactBeBackDate3","dteContactBeBackDate4","dteContactBeBackDate5","dteContactBeBackDate6","dteContactBeBackDate7","dteContactBeBackDate8","dteContactBeBackDate9","intContactCategoryID","intContactCommunityID","intContactContactStatusID","intContactContactTypeID","intContactID",])
@Index("idx_17079_IX_A3_tblContact",["intContactCategoryID","intContactCommunityID","intContactContactTypeID","intContactID","varContactEmailPrimary","varContactFirstName","varContactLastName",])
@Index("idx_17079_IX_tblContact_Reporting1",["intContactCommunityID","intContactCommunityID_Org","intContactContactStatusID","intContactContactTypeID","intContactID","intContactID_OSC",])
...
export class tblContact {
    ...
    @OneToMany(type=>tblContactAutomatedEmailCancelled, tblContactAutomatedEmailCancelled=>tblContactAutomatedEmailCancelled.intContactAutomatedEmailCancelledContact,{ onDelete: 'CASCADE' , })
    tblContactAutomatedEmailCancelleds:tblContactAutomatedEmailCancelled[];
    

   
    @OneToMany(type=>tblContactAutomatedEmailPaused, tblContactAutomatedEmailPaused=>tblContactAutomatedEmailPaused.intContactAutomatedEmailPausedContact,{ onDelete: 'CASCADE' , })
    tblContactAutomatedEmailPauseds:tblContactAutomatedEmailPaused[];
    

   
    @OneToMany(type=>tblContactAutomatedEmailScheduled, tblContactAutomatedEmailScheduled=>tblContactAutomatedEmailScheduled.intContactAutomatedEmailScheduledContact,{ onDelete: 'CASCADE' , })
    tblContactAutomatedEmailScheduleds:tblContactAutomatedEmailScheduled[];
    

   
    @OneToMany(type=>tblContactAutomatedEmailSent, tblContactAutomatedEmailSent=>tblContactAutomatedEmailSent.intContactAutomatedEmailSentContact,{ onDelete: 'CASCADE' , })
    tblContactAutomatedEmailSents:tblContactAutomatedEmailSent[];
    

   
    @OneToMany(type=>tblFPUserContact, tblFPUserContact=>tblFPUserContact.intFPuserContactContact,{ onDelete: 'CASCADE' , })
    tblFpUserContacts:tblFPUserContact[];
    

   
    @OneToMany(type=>tblHomeEstimate, tblHomeEstimate=>tblHomeEstimate.intHomeEstimateContact,{ onDelete: 'SET NULL' , })
