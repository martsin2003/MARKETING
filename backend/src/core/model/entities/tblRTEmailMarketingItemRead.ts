...
@Index(
  'idx_19946_IX_tblRTEmailMarketingItemRead',
  [
    'intRTEmailMarketingItemReadCampaignAPIID',
    'intRTEmailMarketingItemReadCampaignID',
    'intRtEmailMarketingItemReadItem'
  ],
  { unique: true }
)
export class tblRTEmailMarketingItemRead {
  ...
  @ManyToOne(
    ...
    tblRTEmailMarketingItem => tblRTEmailMarketingItem.tblRtEmailMarketingItemReads,
