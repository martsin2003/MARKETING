...
@Index("idx_18625_IX_tblMBFPhase",["dteMBFPhaseModifiedDate","intMBFPhaseID","intMBFPhaseNavOrder","varMBFPhaseName",],{unique:true})
export class tblMBFPhase {
    ...
    @OneToMany(type=>tblMBFLotNotification, tblMBFLotNotification=>tblMBFLotNotification.intMbfLotNotificationPhase,{ onDelete: 'CASCADE' , })
    tblMbfLotNotifications:tblMBFLotNotification[];
    

   
    @OneToMany(type=>tblMBFLotToDo, tblMBFLotToDo=>tblMBFLotToDo.intMbfLotToDoPhase,{ onDelete: 'CASCADE' , })
