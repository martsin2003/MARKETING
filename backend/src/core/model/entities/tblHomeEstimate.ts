...
@Index("idx_18006_IX_tblHomeEstimate2",["dteHomeEstimateModifiedDate","intHomeEstimateCommunity","intHomeEstimateContact","intHomeEstimateType","varHomeEstimateElevationName","varHomeEstimateName","varHomeEstimatePlanName","varHomeEstimateStatus",],{unique:true})
@Index("idx_18006_IX_tblHomeEstimate",["dteHomeEstimateModifiedDate","varHomeEstimateModelGenericElevationName","varHomeEstimateModelGenericName","varHomeEstimateName","varHomeEstimateStatus",],{unique:true})
export class tblHomeEstimate {
    ...
    @ManyToOne(type=>tblCommunity, tblCommunity=>tblCommunity.tblHomeEstimates,{ onDelete: 'SET NULL', })
    @JoinColumn({ name:'intHomeEstimateCommunityID'})
    intHomeEstimateCommunity:tblCommunity | null;


   
    @ManyToOne(type=>tblContact, tblContact=>tblContact.tblHomeEstimates,{ onDelete: 'SET NULL', })
    ...
    @ManyToOne(type=>tblMoveInNow, tblMoveInNow=>tblMoveInNow.tblHomeEstimates,{ onDelete: 'SET NULL', })
    @JoinColumn({ name:'intHomeEstimateMoveInNowID'})
    intHomeEstimateMoveInNow:tblMoveInNow | null;


   
    @ManyToOne(type=>tblModelGeneric, tblModelGeneric=>tblModelGeneric.tblHomeEstimates,{ onDelete: 'SET NULL', })
    ...
    @ManyToOne(type=>tblModelGenericElevation, tblModelGenericElevation=>tblModelGenericElevation.tblHomeEstimates,{ onDelete: 'SET NULL', })
    ...
    @ManyToOne(type=>tblSiteplan, tblSiteplan=>tblSiteplan.tblHomeEstimates,{ onDelete: 'SET NULL', })
    ...
    @ManyToOne(type=>tblModelPlanProject, tblModelPlanProject=>tblModelPlanProject.tblHomeEstimates,{  })
    ...
    @ManyToOne(type=>tblContractPlanContractPlanProjectXRef, tblContractPlanContractPlanProjectXRef=>tblContractPlanContractPlanProjectXRef.tblHomeEstimates,{  })
    ...
    @OneToMany(type=>tblHomeEstimateFinancePlan, tblHomeEstimateFinancePlan=>tblHomeEstimateFinancePlan.intHomeEstimate,{ onDelete: 'CASCADE' , })
    tblHomeEstimateFinancePlans:tblHomeEstimateFinancePlan[];
    

   
    @OneToMany(type=>tblHomeEstimateFinancePlanXRef, tblHomeEstimateFinancePlanXRef=>tblHomeEstimateFinancePlanXRef.intHomeEstimate,{ onDelete: 'CASCADE' , })
    tblHomeEstimateFinancePlanXRefs:tblHomeEstimateFinancePlanXRef[];
    

   
    @OneToMany(type=>tblHomeEstimateOption, tblHomeEstimateOption=>tblHomeEstimateOption.intHomeEstimateOptionHomeEstimate,{ onDelete: 'CASCADE' , })
