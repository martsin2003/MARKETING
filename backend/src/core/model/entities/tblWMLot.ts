...
@Index(
  'idx_20848_IX_tblWMLot_GiftedTo',
  [
    'dteWMLotSoldDate',
    'intWmLotGiftedToWmBuilder',
    'intWmLotWmSection',
    'varWMLotConstructionStatus',
    'varWMLotIdentifier',
    'varWMLotSalesStatus',
    'varWMLotStatus'
  ],
...
@Index(
  'idx_20848_IX_tblWMLot_OwnedBy',
  [
    'dteWMLotSoldDate',
    'intWmLotOwnedByWmBuilder',
    'intWmLotWmSection',
    'varWMLotConstructionStatus',
    'varWMLotIdentifier',
    'varWMLotSalesStatus',
...
@Index(
  'idx_20848_IX_tblWMLot_SoldTo',
  [
    'dteWMLotSoldDate',
    'intWmLotSoldToWmBuilder',
    'intWmLotWmSection',
    'varWMLotConstructionStatus',
    'varWMLotIdentifier',
    'varWMLotSalesStatus',
...
@Index(
  'idx_20848_IX_tblWMLot_SoldBy',
  [
    'dteWMLotSoldDate',
    'intWmLotSoldByWmBuilder',
    'intWmLotWmSection',
    'varWMLotConstructionStatus',
    'varWMLotIdentifier',
    'varWMLotSalesStatus',
...
export class tblWMLot {
  ...
  @ManyToOne(type => tblWMSection, tblWMSection => tblWMSection.tblWmLots, {
    nullable: false,
    onDelete: 'CASCADE'
  })
  ...
  @OneToMany(
    ...
    tblMoveInNowWMLot => tblMoveInNowWMLot.intMoveInNowWmLotWmLot,
    { onDelete: 'CASCADE' }
  )
