...
export class tblEmailMarketingSentTargetCRM {
    ...
    @ManyToOne(type=>tblEmailMarketingSent, tblEmailMarketingSent=>tblEmailMarketingSent.tblEmailMarketingSentTargetCrms,{ primary:true, nullable:false,onDelete: 'CASCADE', })
