...
@Index("idx_20814_IX_tblWMCommunitySeries",["intWMCommunitySeriesID","intWmCommunitySeriesWmCommunity","varWMCommunitySeriesColor","varWMCommunitySeriesName","varWMCommunitySeriesStatus",],{unique:true})
export class tblWMCommunitySeries {
    ...
    @ManyToOne(type=>tblWMCommunity, tblWMCommunity=>tblWMCommunity.tblWmCommunitySeriess,{  nullable:false,onDelete: 'CASCADE', })
