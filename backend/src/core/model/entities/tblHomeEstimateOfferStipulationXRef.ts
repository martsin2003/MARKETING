...
@Index("idx_18155_IX_tblHomeEstimateOfferStipulationXRef",["intHomeEstimateOfferID","intHomeEstimateOfferStipulation",],{unique:true})
export class tblHomeEstimateOfferStipulationXRef {
    ...
    @ManyToOne(type=>tblHomeEstimateOfferStipulation, tblHomeEstimateOfferStipulation=>tblHomeEstimateOfferStipulation.tblHomeEstimateOfferStipulationXRefs,{  nullable:false,onDelete: 'CASCADE', })
