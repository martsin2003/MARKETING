...
@Index("idx_16859_IX_tblCommunityFlag",["bCommunityFlagDisplay","dteCommunityFlagCreatedDate","dteCommunityFlagModifiedDate","intCommunityFlagCommunity","intCommunityFlagFlag","intCommunityFlagOrder",],{unique:true})
export class tblCommunityFlag {
    ...
    @ManyToOne(type=>tblCommunity, tblCommunity=>tblCommunity.tblCommunityFlags,{ onDelete: 'SET NULL', })
