...
export class tblCommunityARHeaderGraphicARType {
    ...
    @OneToMany(type=>tblCommunityARHeaderGraphicCategory, tblCommunityARHeaderGraphicCategory=>tblCommunityARHeaderGraphicCategory.intCommunityArHeaderGraphicCategoryCommunityArHeaderGraphicArTy,{ onDelete: 'CASCADE' , })
