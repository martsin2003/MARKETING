...
@Index("idx_18958_IX_tblMoveInNow_community_status",["intMoveInNowCommunityID","varMoveInNowStatus",])
export class tblMoveInNow {
    ...
    @OneToMany(type=>tblHomeEstimate, tblHomeEstimate=>tblHomeEstimate.intHomeEstimateMoveInNow,{ onDelete: 'SET NULL' , })
    tblHomeEstimates:tblHomeEstimate[];
    

   
    @OneToMany(type=>tblMoveInNowStatusLog, tblMoveInNowStatusLog=>tblMoveInNowStatusLog.intMoveInNowStatusLogMoveInNow,{ onDelete: 'CASCADE' , })
    tblMoveInNowStatusLogs:tblMoveInNowStatusLog[];
    

   
    @OneToMany(type=>tblMoveInNowWMLot, tblMoveInNowWMLot=>tblMoveInNowWMLot.intMoveInNowWmLotMoveInNow,{ onDelete: 'CASCADE' , })
    tblMoveInNowWmLots:tblMoveInNowWMLot[];
    

   
    @OneToMany(type=>tblMyTimeAcceptTerms, tblMyTimeAcceptTerms=>tblMyTimeAcceptTerms.intMyTimeAcceptTermsMoveInNow,{ onDelete: 'CASCADE' , })
