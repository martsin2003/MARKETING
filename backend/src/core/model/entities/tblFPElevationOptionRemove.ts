...
export class tblFPElevationOptionRemove {
    ...
    @ManyToOne(type=>tblFPElevation, tblFPElevation=>tblFPElevation.tblFpElevationOptionRemoves,{  nullable:false, })
    @JoinColumn({ name:'intFPElevationOptionRemoveFPElevationID'})
    intFpElevationOptionRemoveFpElevation:tblFPElevation | null;


   
    @ManyToOne(type=>tblFPFloorOption, tblFPFloorOption=>tblFPFloorOption.tblFpElevationOptionRemoves,{  nullable:false, })
