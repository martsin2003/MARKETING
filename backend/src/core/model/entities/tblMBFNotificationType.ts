...
export class tblMBFNotificationType {
    ...
    @OneToMany(type=>tblMBFDashboard, tblMBFDashboard=>tblMBFDashboard.intMbfDashboardNotificationType,{ onDelete: 'CASCADE' , })
    tblMbfDashboards:tblMBFDashboard[];
    

   
    @OneToMany(type=>tblMBFPushNotification, tblMBFPushNotification=>tblMBFPushNotification.intMbfPushNotificationMbfNotificationType,{ onDelete: 'CASCADE' , })
