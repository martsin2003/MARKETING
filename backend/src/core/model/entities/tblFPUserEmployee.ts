...
@Index("idx_17968_IX_tblFPUserEmployee",["bFPUserEmployeeDeletedFlg","intFpUserEmployeeFpUser","lngUserID",],{unique:true})
export class tblFPUserEmployee {
    ...
    @ManyToOne(type=>tblFPUser, tblFPUser=>tblFPUser.tblFpUserEmployees,{  nullable:false,onDelete: 'CASCADE', })
