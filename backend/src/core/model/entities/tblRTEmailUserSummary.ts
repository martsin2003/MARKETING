...
@Index("idx_19973_IX_tblRTEmailUserSummary",["dteRTEmailUserSummaryResponseDate","intRTEmailUserSummaryContactID","intRtEmailUserSummaryEmailAction","intRtEmailUserSummaryEmailMarketingItem","intRTEmailUserSummaryID","varRTEmailUserSummaryEmailAddress","varRTEmailUserSummaryStatus",],{unique:true})
export class tblRTEmailUserSummary {
    ...
    @ManyToOne(type=>tblRTEmailMarketingItem, tblRTEmailMarketingItem=>tblRTEmailMarketingItem.tblRtEmailUserSummarys,{  nullable:false,onDelete: 'CASCADE', })
    ...
    @ManyToOne(type=>tblRTEmailAction, tblRTEmailAction=>tblRTEmailAction.tblRtEmailUserSummarys,{  nullable:false,onDelete: 'CASCADE', })
