...
@Index(
  'idx_18140_IX_tblHomeEstimateOfferContract',
  ['intHomeEstimateOfferContractContractID', 'intHomeEstimateOfferContractHomeEstimateOffer'],
  { unique: true }
)
export class tblHomeEstimateOfferContract {
  ...
  @ManyToOne(
    ...
    tblHomeEstimateOffer => tblHomeEstimateOffer.tblHomeEstimateOfferContracts,
