...
@Index("idx_17986_IX_tblHEOption",["intHeOptionHeOptionGroup","varHEOptionCode","varHEOptionGroupCode","varHEOptionOptionGroupHash","varHEOptionStatus",],{unique:true})
export class tblHEOption {
    ...
    @OneToMany(type=>tblHomeEstimateOption, tblHomeEstimateOption=>tblHomeEstimateOption.intHomeEstimateOptionHeOption)
    tblHomeEstimateOptions:tblHomeEstimateOption[];
    

   
    @OneToMany(type=>tblModelPlanProjectHEOption, tblModelPlanProjectHEOption=>tblModelPlanProjectHEOption.intModelPlanProjectHeOptionHeOption)
    tblModelPlanProjectHeOptions:tblModelPlanProjectHEOption[];
    

   
    @OneToMany(type=>tblPaperSpecOption, tblPaperSpecOption=>tblPaperSpecOption.intPaperSpecOptionHeOption)
