...
@Index(
  'idx_17316_IX_tblContractPlanContractPlanProjectXRef',
  [
    'dteContractPlanContractPlanProjectXRefCreatedDate',
    'intContractPlanContractPlanProjectXRefContractPlan',
    'intContractPlanContractPlanProjectXRefContractPlanProject',
    'intContractPlanContractPlanProjectXRefCreatedBy'
  ],
  { unique: true }
)
export class tblContractPlanContractPlanProjectXRef {
  ...
  @ManyToOne(
    type => tblContractPlan,
    tblContractPlan => tblContractPlan.tblContractPlanContractPlanProjectXRefs,
  ...
  @ManyToOne(
    ...
    tblContractPlanProject => tblContractPlanProject.tblContractPlanContractPlanProjectXRefs,
    { nullable: false, onDelete: 'CASCADE' }
  )
  ...
  @OneToMany(
    ...
    tblHomeEstimate => tblHomeEstimate.intHomeEstimateContractPlanContractPlanProjectXRef
  )
  tblHomeEstimates: tblHomeEstimate[];

  @OneToMany(
    type => tblPaperSpec,
    tblPaperSpec => tblPaperSpec.intPaperSpecContractPlanContractPlanProjectXRef,
    { onDelete: 'CASCADE' }
  )
