...
@Index("idx_18685_IX_tblMBFPhaseVideo",["dteMBFPhaseVideoModifiedDate","intMBFPhaseVideoID","intMBFPhaseVideoPhaseID","varMBFPhaseVideoImageFile","varMBFPhaseVideoName","varMBFPhaseVideoStatus","varMBFPhaseVideoURL",],{unique:true})
