...
@Index("idx_20872_IX_tblWMRecipient",["lngUserID","varWMRecipientEmail","varWMRecipientFName","varWMRecipientLName","varWMRecipientStatus",],{unique:true})
export class tblWMRecipient {
    ...
    @OneToMany(type=>tblWMDistribution, tblWMDistribution=>tblWMDistribution.intWmDistributionWmRecipient,{ onDelete: 'CASCADE' , })
