...
@Index("idx_17997_IX_tblHEOptionGroup",["varHEOptionGroupCRMDisplayText","varHEOptionGroupCode","varHEOptionGroupDesc","varHEOptionGroupStatus",],{unique:true})
export class tblHEOptionGroup {
    ...
    @OneToMany(type=>tblHomeEstimateOption, tblHomeEstimateOption=>tblHomeEstimateOption.intHomeEstimateOptionHeOptionGroup)
    tblHomeEstimateOptions:tblHomeEstimateOption[];
    

   
    @OneToMany(type=>tblPaperSpecOption, tblPaperSpecOption=>tblPaperSpecOption.intPaperSpecOptionHeOptionGroup)
