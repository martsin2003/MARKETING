...
export class tblRTCredentialProvider {
    ...
    @OneToMany(type=>tblRTDisplayGoal, tblRTDisplayGoal=>tblRTDisplayGoal.intRtDisplayGoalRtCredentialProvider,{ onDelete: 'CASCADE' , })
    tblRtDisplayGoals:tblRTDisplayGoal[];
    

   
    @OneToMany(type=>tblRTPaidSearchBudget, tblRTPaidSearchBudget=>tblRTPaidSearchBudget.intRtPaidSearchBudgetRtCredentialProvider,{ onDelete: 'CASCADE' , })
    tblRtPaidSearchBudgets:tblRTPaidSearchBudget[];
    

   
    @OneToMany(type=>tblRTPaidSearchGoal, tblRTPaidSearchGoal=>tblRTPaidSearchGoal.intRtPaidSearchGoalRtCredentialProvider,{ onDelete: 'CASCADE' , })
