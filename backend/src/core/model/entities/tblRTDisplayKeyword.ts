...
@Index(
  'idx_19811_IX_tblRTDisplayKeyword',
  [
    'intRTDisplayKeywordAPIID',
    'intRTDisplayKeywordID',
    'intRtDisplayKeywordRtDisplayAdGroup',
    'varRTDisplayKeyword',
    'varRTDisplayKeywordMatchType',
    'varRTDisplayKeywordStatus'
  ],
  { unique: true }
)
export class tblRTDisplayKeyword {
  ...
  @ManyToOne(
    ...
    tblRTDisplayAdGroup => tblRTDisplayAdGroup.tblRtDisplayKeywords,
  ...
  @OneToMany(
    ...
    tblRTDisplayGoalKeywordData =>
      tblRTDisplayGoalKeywordData.intRtDisplayGoalKeywordDataRtDisplayKeyword,
    { onDelete: 'CASCADE' }
  )
  ...
  @OneToMany(
    ...
    tblRTDisplayKeywordData => tblRTDisplayKeywordData.intRtDisplayKeywordDataRtDisplayKeyword,
    { onDelete: 'CASCADE' }
  )
