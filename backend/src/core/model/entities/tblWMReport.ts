...
@Index(
  'idx_20882_IX_tblWMReport',
  ['bWMReportDisplayFlg', 'bWMReportDistributeFlg', 'varWMReportDescription', 'varWMReportName'],
  { unique: true }
)
export class tblWMReport {
  ...
  @OneToMany(
    ...
    tblWMDistribution => tblWMDistribution.intWmDistributionWmReport,
    { onDelete: 'CASCADE' }
  )
  ...
  @OneToMany(
    ...
    tblWMReportDistribution => tblWMReportDistribution.intWmReportDistributionWmReport,
    { onDelete: 'CASCADE' }
  )
