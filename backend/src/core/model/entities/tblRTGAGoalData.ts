...
@Index(
  'idx_20113_IX_tblRTGAGoalData',
  ['dteRTGAGoalDataDate', 'intRTGAGoalDataID', 'intRtgaGoalDataRtgaGoal', 'intRTGAGoalDataValue'],
  { unique: true }
)
export class tblRTGAGoalData {
  ...
  @ManyToOne(type => tblRTGAGoal, tblRTGAGoal => tblRTGAGoal.tblRtgaGoalDatas, {
    nullable: false,
    onDelete: 'CASCADE'
  })
