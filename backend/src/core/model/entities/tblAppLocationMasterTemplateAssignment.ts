...
export class tblAppLocationMasterTemplateAssignment {
    ...
    @ManyToOne(type=>tblAppLocationMasterTemplate, tblAppLocationMasterTemplate=>tblAppLocationMasterTemplate.tblAppLocationMasterTemplateAssignments,{ primary:true, nullable:false,onDelete: 'CASCADE', })
    ...
    @ManyToOne(type=>tblWMProject, tblWMProject=>tblWMProject.tblAppLocationMasterTemplateAssignments,{ primary:true, nullable:false,onDelete: 'CASCADE', })
