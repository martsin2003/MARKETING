...
@Index("idx_18726_IX_tblMBFTeamMemberSalesReportUser",["intMbfTeamMemberSalesReportUserMbfTeamMember","intMbfTeamMemberSalesReportUserSalesRepUser",],{unique:true})
export class tblMBFTeamMemberSalesReportUser {

   
    @ManyToOne(type=>tblMBFTeamMember, tblMBFTeamMember=>tblMBFTeamMember.tblMbfTeamMemberSalesReportUsers,{ primary:true, nullable:false, })
    ...
    @ManyToOne(type=>tblSalesReportUser, tblSalesReportUser=>tblSalesReportUser.tblMbfTeamMemberSalesReportUsers,{ primary:true, nullable:false, })
