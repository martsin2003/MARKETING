...
export class tblTrafficReport {
    ...
    @OneToMany(type=>tblNewTrafficSource, tblNewTrafficSource=>tblNewTrafficSource.lngTrafficReport,{ onDelete: 'CASCADE' , })
    tblNewTrafficSources:tblNewTrafficSource[];
    

   
    @OneToMany(type=>tblNewTrafficZipCode, tblNewTrafficZipCode=>tblNewTrafficZipCode.lngTrafficReport,{ onDelete: 'CASCADE' , })
    tblNewTrafficZipCodes:tblNewTrafficZipCode[];
    

   
    @OneToMany(type=>tblSettlement, tblSettlement=>tblSettlement.lngTrafficReport,{ onDelete: 'CASCADE' , })
    tblSettlements:tblSettlement[];
    

   
    @OneToMany(type=>tblTopProspect, tblTopProspect=>tblTopProspect.lngTrafficReport,{ onDelete: 'CASCADE' , })
    tblTopProspects:tblTopProspect[];
    

   
    @OneToMany(type=>tblTopRealtor, tblTopRealtor=>tblTopRealtor.lngTrafficReport,{ onDelete: 'CASCADE' , })
