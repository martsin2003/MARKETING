...
@Index(
  'idx_19805_IX_tblRTDisplayGoalKeywordData',
  [
    'dteRTDisplayGoalKeywordDataDate',
    'intRTDisplayGoalKeywordDataID',
    'intRtDisplayGoalKeywordDataRtDisplayGoal',
    'intRtDisplayGoalKeywordDataRtDisplayKeyword'
  ],
  { unique: true }
)
export class tblRTDisplayGoalKeywordData {
  ...
  @ManyToOne(
    ...
    tblRTDisplayKeyword => tblRTDisplayKeyword.tblRtDisplayGoalKeywordDatas,
  ...
  @ManyToOne(
    ...
    tblRTDisplayGoal => tblRTDisplayGoal.tblRtDisplayGoalKeywordDatas,
    { nullable: false, onDelete: 'CASCADE' }
  )
