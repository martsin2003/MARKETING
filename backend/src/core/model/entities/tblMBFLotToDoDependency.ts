...
@Index("idx_18557_IX_tblMBFLotToDoDependency",["intMBFLotToDoDependencyID","intMBFLotToDoDependencyOrder","intMbfLotToDoDependencyToDoDependent","intMBFLotToDoDependencyToDoID",],{unique:true})
export class tblMBFLotToDoDependency {
    ...
    @ManyToOne(type=>tblMBFLotToDo, tblMBFLotToDo=>tblMBFLotToDo.tblMbfLotToDoDependencys,{  nullable:false,onDelete: 'CASCADE', })
