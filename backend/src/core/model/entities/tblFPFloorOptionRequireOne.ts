...
@Index(
  'idx_17878_IX_tblFPFloorOptionRequireOne',
  ['intFPFloorOptionRequireOneFPFloorOptionID', 'intFpFloorOptionRequireOneTargetFpFloorOption'],
  { unique: true }
)
export class tblFPFloorOptionRequireOne {
  ...
  @ManyToOne(
    ...
    tblFPFloorOption => tblFPFloorOption.tblFpFloorOptionRequireOnes,
    { nullable: false }
  )
