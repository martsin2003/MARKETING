...
@Index("idx_18081_IX_tblHomeEstimateFinancePlanXRef",["intFinancePlan","intHomeEstimateFinancePlanID","intHomeEstimate",],{unique:true})
export class tblHomeEstimateFinancePlanXRef {
    ...
    @ManyToOne(type=>tblHomeEstimate, tblHomeEstimate=>tblHomeEstimate.tblHomeEstimateFinancePlanXRefs,{ onDelete: 'CASCADE', })
    ...
    @ManyToOne(type=>tblFinancePlan, tblFinancePlan=>tblFinancePlan.tblHomeEstimateFinancePlanXRefs,{ onDelete: 'SET NULL', })
    @JoinColumn({ name:'intFinancePlanID'})
    intFinancePlan:tblFinancePlan | null;


   
    @OneToMany(type=>tblHomeEstimateOffer, tblHomeEstimateOffer=>tblHomeEstimateOffer.intHomeEstimateFinancePlanXRef,{ onDelete: 'CASCADE' , })
