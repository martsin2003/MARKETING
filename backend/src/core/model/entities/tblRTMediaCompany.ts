...
export class tblRTMediaCompany {
    ...
    @OneToMany(type=>tblRTListingResponseSpend, tblRTListingResponseSpend=>tblRTListingResponseSpend.intRtListingResponseSpendRtMediaCompany,{ onDelete: 'CASCADE' , })
    tblRtListingResponseSpends:tblRTListingResponseSpend[];
    

   
    @OneToMany(type=>tblRTMediaCompanyContact, tblRTMediaCompanyContact=>tblRTMediaCompanyContact.intRtMediaCompanyContactRtMediaCompany,{ onDelete: 'CASCADE' , })
