...
@Index("idx_16471_IX_tblAppMassMessageSent",["dteAppMassMessageSentTimestamp","intAppMassMessageSentID","intAppMassMessageSentMessage","intAppMassMessageSentPushNotificationsSentCount","intAppMassMessageSentRecipientCount",],{unique:true})
export class tblAppMassMessageSent {
    ...
    @ManyToOne(type=>tblAppMassMessage, tblAppMassMessage=>tblAppMassMessage.tblAppMassMessageSents,{  nullable:false,onDelete: 'CASCADE', })
