...
@Index("idx_20323_IX_tblRTPaidSearchGAGoalAdData",["dteRTPaidSearchGAGoalAdDataDate","intRtPaidSearchGaGoalAdDataRtgaGoal","intRtPaidSearchGaGoalAdDataRtPaidSearchAd","intRTPaidSearchGAGoalAdDataValue",],{unique:true})
@Index("idx_20323_IX2_tblRTPaidSearchGAGoalAdData",["dteRTPaidSearchGAGoalAdDataDate","intRTPaidSearchGAGoalAdDataID","intRtPaidSearchGaGoalAdDataRtgaGoal","intRtPaidSearchGaGoalAdDataRtPaidSearchAd","intRTPaidSearchGAGoalAdDataValue",])
export class tblRTPaidSearchGAGoalAdData {
    ...
    @ManyToOne(type=>tblRTPaidSearchAd, tblRTPaidSearchAd=>tblRTPaidSearchAd.tblRtPaidSearchGaGoalAdDatas,{  nullable:false,onDelete: 'CASCADE', })
    ...
    @ManyToOne(type=>tblRTGAGoal, tblRTGAGoal=>tblRTGAGoal.tblRtPaidSearchGaGoalAdDatas,{  nullable:false, })
