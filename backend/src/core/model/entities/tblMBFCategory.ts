...
export class tblMBFCategory {
    ...
    @OneToMany(type=>tblMBFDocument, tblMBFDocument=>tblMBFDocument.intMbfDocumentCategory,{ onDelete: 'CASCADE' , })
    tblMbfDocuments:tblMBFDocument[];
    

   
    @OneToMany(type=>tblMBFLotDocument, tblMBFLotDocument=>tblMBFLotDocument.intMbfLotDocumentCategory,{ onDelete: 'CASCADE' , })
    tblMbfLotDocuments:tblMBFLotDocument[];
    

   
    @OneToMany(type=>tblMBFPushNotification, tblMBFPushNotification=>tblMBFPushNotification.intMbfPushNotificationMbfCategory,{ onDelete: 'CASCADE' , })
