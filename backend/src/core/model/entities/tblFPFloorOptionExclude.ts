...
export class tblFPFloorOptionExclude {
    ...
    @ManyToOne(type=>tblFPFloorOption, tblFPFloorOption=>tblFPFloorOption.tblFpFloorOptionExcludes,{  nullable:false,onDelete: 'CASCADE', })
    @JoinColumn({ name:'intFPFloorOptionExcludeFPFloorOptionID'})
    intFpFloorOptionExcludeFpFloorOption:tblFPFloorOption | null;


   
    @ManyToOne(type=>tblFPFloorOption, tblFPFloorOption=>tblFPFloorOption.tblFpFloorOptionExcludes2,{  nullable:false, })
