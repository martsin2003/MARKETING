...
@Index("idx_20958_IX_tblWMSectionSeriesMarking",["intWMSectionSeriesMarkingID","intWmSectionSeriesMarkingWmSectionSeries","varWMSectionSeriesMarkingStatus",],{unique:true})
export class tblWMSectionSeriesMarking {
    ...
    @ManyToOne(type=>tblWMSectionSeries, tblWMSectionSeries=>tblWMSectionSeries.tblWmSectionSeriesMarkings,{  nullable:false,onDelete: 'CASCADE', })
