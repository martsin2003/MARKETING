...
@Index(
  'idx_18317_IX_tblMBFBuyer',
  [
    'bMBFBuyerDocumentEmailNotifications',
    'bMBFBuyerDocumentPushNotifications',
    'bMBFBuyerGeneralEmailNotifications',
    'bMBFBuyerGeneralPushNotifications',
    'bMBFBuyerPasswordReset',
    'bMBFBuyerScheduleEmailNotifications',
    'bMBFBuyerSchedulePushNotifications',
    'bMBFBuyerToDoEmailNotifications',
    'bMBFBuyerToDoPushNotifications',
    'dteMBFBuyerModifiedDate',
    'intMBFBuyerID',
    'intMbfBuyerLot',
    'intMbfBuyerType',
    'varMBFBuyerEmailAddress',
    'varMBFBuyerLastName'
  ],
  { unique: true }
)
export class tblMBFBuyer {
  ...
  @ManyToOne(type => tblMBFBuyerType, tblMBFBuyerType => tblMBFBuyerType.tblMbfBuyers, {
    nullable: false,
    onDelete: 'CASCADE'
  })
  ...
  @ManyToOne(type => tblMBFLot, tblMBFLot => tblMBFLot.tblMbfBuyers, {
    nullable: false,
    onDelete: 'CASCADE'
  })
  ...
  @OneToMany(
    ...
    tblMBFAppointmentBuyer => tblMBFAppointmentBuyer.intMbfAppointmentBuyerBuyer,
    { onDelete: 'CASCADE' }
  )
  tblMbfAppointmentBuyers: tblMBFAppointmentBuyer[];

  @OneToMany(
    type => tblMBFBuyerDevice,
    tblMBFBuyerDevice => tblMBFBuyerDevice.intMbfBuyerDeviceMbfBuyer,
    { onDelete: 'CASCADE' }
  )
  tblMbfBuyerDevices: tblMBFBuyerDevice[];

  @OneToMany(
    type => tblMBFBuyerPasswordReset,
    tblMBFBuyerPasswordReset => tblMBFBuyerPasswordReset.intMbfBuyerPasswordResetMbfBuyer,
    { onDelete: 'CASCADE' }
  )
  tblMbfBuyerPasswordResets: tblMBFBuyerPasswordReset[];

  @OneToMany(type => tblMBFDashboard, tblMBFDashboard => tblMBFDashboard.intMbfDashboardBuyer, {
    onDelete: 'CASCADE'
  })
  tblMbfDashboards: tblMBFDashboard[];

  @OneToMany(type => tblMBFLogin, tblMBFLogin => tblMBFLogin.intMbfLoginBuyer, {
    onDelete: 'CASCADE'
  })
  tblMbfLogins: tblMBFLogin[];

  @OneToMany(type => tblMBFMessage, tblMBFMessage => tblMBFMessage.intMbfMessageMbfBuyer, {
    onDelete: 'CASCADE'
  })
