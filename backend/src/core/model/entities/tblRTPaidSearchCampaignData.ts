...
@Index("idx_20316_IX2_tblRTPaidSearchCampaignData",["dteRTPaidSearchCampaignDataEndTime","intRTPaidSearchCampaignDataValue",])
@Index("idx_20316_IX_tblRTPaidSearchCampaignData",["dteRTPaidSearchCampaignDataEndTime","intRtPaidSearchCampaignDataRtCampaign","intRtPaidSearchCampaignDataRtPaidSearchMetric","intRTPaidSearchCampaignDataValue",],{unique:true})
export class tblRTPaidSearchCampaignData {
    ...
    @ManyToOne(type=>tblRTCampaign, tblRTCampaign=>tblRTCampaign.tblRtPaidSearchCampaignDatas,{  nullable:false,onDelete: 'CASCADE', })
    @JoinColumn({ name:'intRTPaidSearchCampaignDataRTCampaignID'})
    intRtPaidSearchCampaignDataRtCampaign:tblRTCampaign | null;


   
    @ManyToOne(type=>tblRTPaidSearchMetric, tblRTPaidSearchMetric=>tblRTPaidSearchMetric.tblRtPaidSearchCampaignDatas,{  nullable:false,onDelete: 'CASCADE', })
