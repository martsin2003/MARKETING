...
@Index('idx_20352_IX_tblRTPaidSearchGoalKeywordData', [
  'dteRTPaidSearchGoalKeywordDataDate',
  'intRTPaidSearchGoalKeywordDataID',
  'intRtPaidSearchGoalKeywordDataRtPaidSearchGoal',
  'intRtPaidSearchGoalKeywordDataRtPaidSearchKeyword'
])
export class tblRTPaidSearchGoalKeywordData {
  ...
  @ManyToOne(
    ...
    tblRTPaidSearchKeyword => tblRTPaidSearchKeyword.tblRtPaidSearchGoalKeywordDatas,
  ...
  @ManyToOne(
    ...
    tblRTPaidSearchGoal => tblRTPaidSearchGoal.tblRtPaidSearchGoalKeywordDatas,
    { nullable: false, onDelete: 'CASCADE' }
  )
