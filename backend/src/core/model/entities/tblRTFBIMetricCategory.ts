...
@Index(
  'idx_20056_IX_tblRTFBIMetricCategory',
  [
    'bRTFBIMetricCategoryArchivedFlg',
    'dteRTFBIMetricCategoryCreatedDate',
    'dteRTFBIMetricCategoryModifiedDate',
    'intRTFBIMetricCategoryID',
    'varRTFBIMetricCategoryName'
  ],
  { unique: true }
)
export class tblRTFBIMetricCategory {
  ...
  @OneToMany(
    ...
    tblRTFBIMetricMetricCategory =>
      tblRTFBIMetricMetricCategory.intRtfbiMetricMetricCategoryCategory,
    { onDelete: 'CASCADE' }
  )
