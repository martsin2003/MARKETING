...
@Index(
  'idx_18722_IX_tblMBFTeamMemberLot',
  ['intMBFTeamMemberLotID', 'intMbfTeamMemberLotLot', 'intMbfTeamMemberLotTeamMember'],
  { unique: true }
)
export class tblMBFTeamMemberLot {
  ...
  @ManyToOne(type => tblMBFTeamMember, tblMBFTeamMember => tblMBFTeamMember.tblMbfTeamMemberLots, {
    nullable: false,
    onDelete: 'CASCADE'
  })
  ...
  @ManyToOne(type => tblMBFLot, tblMBFLot => tblMBFLot.tblMbfTeamMemberLots, {
    nullable: false,
    onDelete: 'CASCADE'
  })
