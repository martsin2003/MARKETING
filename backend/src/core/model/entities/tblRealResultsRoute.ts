...
@Index("idx_19386_IX_tblRealResultsRoute",["dteRealResultsRouteCreatedDate","dteRealResultsRouteModifiedDate","intRealResultsRouteCreatedBy","intRealResultsRouteModifiedBy","varRealResultsRoute","varRealResultsRouteAction","varRealResultsRouteAlias","varRealResultsRouteController","varRealResultsRoutePattern",],{unique:true})
export class tblRealResultsRoute {
    ...
    @OneToMany(type=>tblRealResultsRoutePermission, tblRealResultsRoutePermission=>tblRealResultsRoutePermission.intRealResultsRoute,{ onDelete: 'CASCADE' , })
