...
export class tblRTFBAIMetric {
    ...
    @OneToMany(type=>tblRTFBAIData, tblRTFBAIData=>tblRTFBAIData.intRtfbaiDataMetric,{ onDelete: 'CASCADE' , })
    tblRtfbaiDatas:tblRTFBAIData[];
    

   
    @OneToMany(type=>tblRTFBAILabeledData, tblRTFBAILabeledData=>tblRTFBAILabeledData.intRtfbaiLabeledDataMetric,{ onDelete: 'CASCADE' , })
