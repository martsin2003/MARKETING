...
@Index("idx_20044_IX_tblRTFBIMetric",["bRTFBIMetricArchivedFlg","dteRTFBIMetricCreatedDate","dteRTFBIMetricModifiedDate","intRTFBIMetricID","varRTFBIMetricDataStoreType","varRTFBIMetricName","varRTFBIMetricTitle",],{unique:true})
export class tblRTFBIMetric {
    ...
    @OneToMany(type=>tblRTFBIData, tblRTFBIData=>tblRTFBIData.intRtfbiDataMetric,{ onDelete: 'CASCADE' , })
    tblRtfbiDatas:tblRTFBIData[];
    

   
    @OneToMany(type=>tblRTFBILabeledData, tblRTFBILabeledData=>tblRTFBILabeledData.intRtfbiLabeledDataMetric,{ onDelete: 'CASCADE' , })
    tblRtfbiLabeledDatas:tblRTFBILabeledData[];
    

   
    @OneToMany(type=>tblRTFBIMetricMetricCategory, tblRTFBIMetricMetricCategory=>tblRTFBIMetricMetricCategory.intRtfbiMetricMetricCategoryMetric,{ onDelete: 'CASCADE' , })
