...
export class TblCommunityServiceGenerated {
  ...
  createTblCommunityGeneratedMutation(
    variables: CreateTblCommunityGeneratedMutationVariables
  ): Observable<CreateTblCommunityGeneratedMutation> {
    return this.apollo
      .mutate({ mutation: createTblCommunityGeneratedMutation, variables })
      .pipe(map((queryResult: any) => queryResult.data as any));
  }

  updateTblCommunityGeneratedMutation(
    variables: UpdateTblCommunityGeneratedMutationVariables
  ): Observable<UpdateTblCommunityGeneratedMutation> {
    return this.apollo
      .mutate({ mutation: updateTblCommunityGeneratedMutation, variables })
      .pipe(map((queryResult: any) => queryResult.data as any));
  }

  updateTblCommunityByIntCommunityIdGeneratedMutation(
    variables: UpdateTblCommunityByIntCommunityIdGeneratedMutationVariables
  ): Observable<UpdateTblCommunityByIntCommunityIdGeneratedMutation> {
    return this.apollo
      .mutate({ mutation: updateTblCommunityByIntCommunityIdGeneratedMutation, variables })
      .pipe(map((queryResult: any) => queryResult.data as any));
  }

  deleteTblCommunityGeneratedMutation(
    variables: DeleteTblCommunityGeneratedMutationVariables
  ): Observable<DeleteTblCommunityGeneratedMutation> {
    return this.apollo
      .mutate({ mutation: deleteTblCommunityGeneratedMutation, variables })
      .pipe(map((queryResult: any) => queryResult.data as any));
  }

  deleteTblCommunityByIntCommunityIdGeneratedMutation(
    variables: DeleteTblCommunityByIntCommunityIdGeneratedMutationVariables
  ): Observable<DeleteTblCommunityByIntCommunityIdGeneratedMutation> {
    return this.apollo
      .mutate({ mutation: deleteTblCommunityByIntCommunityIdGeneratedMutation, variables })
      .pipe(map((queryResult: any) => queryResult.data as any));
  }

  allTblCommunitiesGeneratedQuery(
    variables: AllTblCommunitiesGeneratedQueryVariables
  ): Observable<AllTblCommunitiesGeneratedQuery> {
    return this.apollo
      .query({ query: allTblCommunitiesGeneratedQuery, variables, fetchPolicy: 'network-only' })
      .pipe(
        map((queryResult: any) => {
  ...
  tblCommunityByIntCommunityIdGeneratedQuery(
    variables: TblCommunityByIntCommunityIdGeneratedQueryVariables
  ): Observable<TblCommunityByIntCommunityIdGeneratedQuery> {
    return this.apollo
      .query({
        query: tblCommunityByIntCommunityIdGeneratedQuery,
        variables,
  ...
  tblCommunityGeneratedQuery(
    variables: TblCommunityGeneratedQueryVariables
  ): Observable<TblCommunityGeneratedQuery> {
    return this.apollo
      .query({ query: tblCommunityGeneratedQuery, variables, fetchPolicy: 'network-only' })
      .pipe(map((queryResult: any) => queryResult.data as any));
  }
}
